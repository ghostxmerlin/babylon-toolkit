...
export const QueryEndedEpochBtcHeightRequest: MessageFns<QueryEndedEpochBtcHeightRequest> = {
  encode(message: QueryEndedEpochBtcHeightRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEndedEpochBtcHeightRequest {
  ...
  create<I extends Exact<DeepPartial<QueryEndedEpochBtcHeightRequest>, I>>(base?: I): QueryEndedEpochBtcHeightRequest {
    return QueryEndedEpochBtcHeightRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEndedEpochBtcHeightRequest>, I>>(
    object: I,
...
export const QueryEndedEpochBtcHeightResponse: MessageFns<QueryEndedEpochBtcHeightResponse> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEndedEpochBtcHeightResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryEndedEpochBtcHeightResponse>, I>>(
    object: I,
  ): QueryEndedEpochBtcHeightResponse {
    const message = createBaseQueryEndedEpochBtcHeightResponse();
...
export const QueryReportedCheckpointBtcHeightRequest: MessageFns<QueryReportedCheckpointBtcHeightRequest> = {
  encode(message: QueryReportedCheckpointBtcHeightRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ckptHash !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryReportedCheckpointBtcHeightRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QueryReportedCheckpointBtcHeightRequest {
    return { ckptHash: isSet(object.ckptHash) ? globalThis.String(object.ckptHash) : "" };
  },
  ...
  create<I extends Exact<DeepPartial<QueryReportedCheckpointBtcHeightRequest>, I>>(
    base?: I,
  ): QueryReportedCheckpointBtcHeightRequest {
    return QueryReportedCheckpointBtcHeightRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryReportedCheckpointBtcHeightRequest>, I>>(
    object: I,
  ): QueryReportedCheckpointBtcHeightRequest {
    const message = createBaseQueryReportedCheckpointBtcHeightRequest();
...
export const QueryReportedCheckpointBtcHeightResponse: MessageFns<QueryReportedCheckpointBtcHeightResponse> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryReportedCheckpointBtcHeightResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryReportedCheckpointBtcHeightResponse>, I>>(
    base?: I,
  ): QueryReportedCheckpointBtcHeightResponse {
    return QueryReportedCheckpointBtcHeightResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryReportedCheckpointBtcHeightResponse>, I>>(
    object: I,
  ): QueryReportedCheckpointBtcHeightResponse {
    const message = createBaseQueryReportedCheckpointBtcHeightResponse();
    message.btcLightClientHeight = object.btcLightClientHeight ?? 0;
...
export interface Query {
   ...
   * finish
   */
  EndedEpochBtcHeight(request: QueryEndedEpochBtcHeightRequest): Promise<QueryEndedEpochBtcHeightResponse>;
  /**
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.ReportedCheckpointBtcHeight = this.ReportedCheckpointBtcHeight.bind(this);
  }
  EndedEpochBtcHeight(request: QueryEndedEpochBtcHeightRequest): Promise<QueryEndedEpochBtcHeightResponse> {
    ...
    return promise.then((data) => QueryEndedEpochBtcHeightResponse.decode(new BinaryReader(data)));
  }

  ReportedCheckpointBtcHeight(
    request: QueryReportedCheckpointBtcHeightRequest,
  ): Promise<QueryReportedCheckpointBtcHeightResponse> {
    const data = QueryReportedCheckpointBtcHeightRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ReportedCheckpointBtcHeight", data);
    return promise.then((data) => QueryReportedCheckpointBtcHeightResponse.decode(new BinaryReader(data)));
  }
}
