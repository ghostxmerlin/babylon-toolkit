...
function createBaseEventBTCRollBack(): EventBTCRollBack {
  return { header: undefined, rollbackFrom: undefined };
}

export const EventBTCRollBack: MessageFns<EventBTCRollBack> = {
  encode(message: EventBTCRollBack, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): EventBTCRollBack {
    return {
      header: isSet(object.header) ? BTCHeaderInfo.fromJSON(object.header) : undefined,
...
export const EventBTCRollForward: MessageFns<EventBTCRollForward> = {
  encode(message: EventBTCRollForward, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== undefined) {
      BTCHeaderInfo.encode(message.header, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const EventBTCHeaderInserted: MessageFns<EventBTCHeaderInserted> = {
  encode(message: EventBTCHeaderInserted, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== undefined) {
      BTCHeaderInfo.encode(message.header, writer.uint32(10).fork()).join();
    }
    return writer;
