...
export const MsgInsertHeaders: MessageFns<MsgInsertHeaders> = {
  encode(message: MsgInsertHeaders, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signer !== "") {
...
export const MsgInsertHeadersResponse: MessageFns<MsgInsertHeadersResponse> = {
  encode(_: MsgInsertHeadersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
