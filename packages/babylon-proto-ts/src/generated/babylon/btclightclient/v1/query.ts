...
export const QueryHashesRequest: MessageFns<QueryHashesRequest> = {
  encode(message: QueryHashesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryHashesResponse: MessageFns<QueryHashesResponse> = {
  encode(message: QueryHashesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryContainsRequest: MessageFns<QueryContainsRequest> = {
  encode(message: QueryContainsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryContainsResponse: MessageFns<QueryContainsResponse> = {
  encode(message: QueryContainsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryContainsBytesRequest: MessageFns<QueryContainsBytesRequest> = {
  encode(message: QueryContainsBytesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash.length !== 0) {
      writer.uint32(10).bytes(message.hash);
    }
    return writer;
...
export const QueryContainsBytesResponse: MessageFns<QueryContainsBytesResponse> = {
  encode(message: QueryContainsBytesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.contains !== false) {
      writer.uint32(8).bool(message.contains);
    }
    return writer;
...
export const QueryMainChainRequest: MessageFns<QueryMainChainRequest> = {
  encode(message: QueryMainChainRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const QueryMainChainResponse: MessageFns<QueryMainChainResponse> = {
  encode(message: QueryMainChainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryTipRequest: MessageFns<QueryTipRequest> = {
  encode(_: QueryTipRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryTipResponse: MessageFns<QueryTipResponse> = {
  encode(message: QueryTipResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== undefined) {
      BTCHeaderInfoResponse.encode(message.header, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryTipResponse {
    return { header: isSet(object.header) ? BTCHeaderInfoResponse.fromJSON(object.header) : undefined };
  },
...
export const QueryBaseHeaderRequest: MessageFns<QueryBaseHeaderRequest> = {
  encode(_: QueryBaseHeaderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryBaseHeaderResponse: MessageFns<QueryBaseHeaderResponse> = {
  encode(message: QueryBaseHeaderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.header !== undefined) {
      BTCHeaderInfoResponse.encode(message.header, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const QueryHeaderDepthRequest: MessageFns<QueryHeaderDepthRequest> = {
  encode(message: QueryHeaderDepthRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash !== "") {
...
export const BTCHeaderInfoResponse: MessageFns<BTCHeaderInfoResponse> = {
  encode(message: BTCHeaderInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCHeaderInfoResponse>, I>>(base?: I): BTCHeaderInfoResponse {
    return BTCHeaderInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCHeaderInfoResponse>, I>>(object: I): BTCHeaderInfoResponse {
    const message = createBaseBTCHeaderInfoResponse();
