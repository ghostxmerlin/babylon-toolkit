...
export const Forks: MessageFns<Forks> = {
  encode(message: Forks, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
function createBaseChainInfo(): ChainInfo {
  return { consumerId: "", latestHeader: undefined, latestForks: undefined, timestampedHeadersCount: 0 };
}
...
export const ChainInfo: MessageFns<ChainInfo> = {
  ...
  fromJSON(object: any): ChainInfo {
    return {
      ...
      latestForks: isSet(object.latestForks) ? Forks.fromJSON(object.latestForks) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<ChainInfo>, I>>(object: I): ChainInfo {
    ...
    message.latestHeader = (object.latestHeader !== undefined && object.latestHeader !== null)
      ...
      : undefined;
    message.latestForks = (object.latestForks !== undefined && object.latestForks !== null)
...
function createBaseProofFinalizedChainInfo(): ProofFinalizedChainInfo {
  return { proofCzHeaderInEpoch: undefined, proofEpochSealed: undefined, proofEpochSubmitted: [] };
}
...
export const ProofFinalizedChainInfo: MessageFns<ProofFinalizedChainInfo> = {
  encode(message: ProofFinalizedChainInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.proofCzHeaderInEpoch !== undefined) {
      ProofOps.encode(message.proofCzHeaderInEpoch, writer.uint32(10).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.proofCzHeaderInEpoch = ProofOps.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromPartial<I extends Exact<DeepPartial<ProofFinalizedChainInfo>, I>>(object: I): ProofFinalizedChainInfo {
    const message = createBaseProofFinalizedChainInfo();
    message.proofCzHeaderInEpoch = (object.proofCzHeaderInEpoch !== undefined && object.proofCzHeaderInEpoch !== null)
