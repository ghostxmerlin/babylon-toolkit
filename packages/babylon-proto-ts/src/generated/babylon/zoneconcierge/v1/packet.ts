...
function createBaseZoneconciergePacketData(): ZoneconciergePacketData {
  return { btcTimestamp: undefined, btcStaking: undefined, consumerSlashing: undefined };
}

export const ZoneconciergePacketData: MessageFns<ZoneconciergePacketData> = {
  encode(message: ZoneconciergePacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.consumerSlashing !== undefined) {
      ConsumerSlashingIBCPacket.encode(message.consumerSlashing, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ZoneconciergePacketData {
  ...
  create<I extends Exact<DeepPartial<ZoneconciergePacketData>, I>>(base?: I): ZoneconciergePacketData {
    return ZoneconciergePacketData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ZoneconciergePacketData>, I>>(object: I): ZoneconciergePacketData {
    const message = createBaseZoneconciergePacketData();
