...
import { ChainInfo, FinalizedChainInfo, Forks, IndexedHeader, ProofFinalizedChainInfo } from "./zoneconcierge";
...
function createBaseQueryHeaderRequest(): QueryHeaderRequest {
  return { consumerId: "", height: 0 };
}

export const QueryHeaderRequest: MessageFns<QueryHeaderRequest> = {
  encode(message: QueryHeaderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryHeaderRequest>, I>>(base?: I): QueryHeaderRequest {
    return QueryHeaderRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryHeaderRequest>, I>>(object: I): QueryHeaderRequest {
    const message = createBaseQueryHeaderRequest();
...
export const QueryHeaderResponse: MessageFns<QueryHeaderResponse> = {
  encode(message: QueryHeaderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryHeaderResponse {
    return {
      ...
      forkHeaders: isSet(object.forkHeaders) ? Forks.fromJSON(object.forkHeaders) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QueryHeaderResponse>, I>>(base?: I): QueryHeaderResponse {
    return QueryHeaderResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryHeaderResponse>, I>>(object: I): QueryHeaderResponse {
    const message = createBaseQueryHeaderResponse();
    message.header = (object.header !== undefined && object.header !== null)
      ? IndexedHeader.fromPartial(object.header)
      : undefined;
    message.forkHeaders = (object.forkHeaders !== undefined && object.forkHeaders !== null)
...
export const QueryChainListRequest: MessageFns<QueryChainListRequest> = {
  encode(message: QueryChainListRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChainListRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryChainListRequest>, I>>(base?: I): QueryChainListRequest {
    return QueryChainListRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryChainListRequest>, I>>(object: I): QueryChainListRequest {
    const message = createBaseQueryChainListRequest();
...
export const QueryChainListResponse: MessageFns<QueryChainListResponse> = {
  encode(message: QueryChainListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChainListResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryChainListResponse>, I>>(base?: I): QueryChainListResponse {
    return QueryChainListResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryChainListResponse>, I>>(object: I): QueryChainListResponse {
    const message = createBaseQueryChainListResponse();
...
export const QueryChainsInfoRequest: MessageFns<QueryChainsInfoRequest> = {
  encode(message: QueryChainsInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.consumerIds) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChainsInfoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryChainsInfoRequest>, I>>(base?: I): QueryChainsInfoRequest {
    return QueryChainsInfoRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryChainsInfoRequest>, I>>(object: I): QueryChainsInfoRequest {
    const message = createBaseQueryChainsInfoRequest();
    message.consumerIds = object.consumerIds?.map((e) => e) || [];
    return message;
  },
...
export const QueryChainsInfoResponse: MessageFns<QueryChainsInfoResponse> = {
  encode(message: QueryChainsInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryChainsInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryChainsInfoResponse>, I>>(base?: I): QueryChainsInfoResponse {
    return QueryChainsInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryChainsInfoResponse>, I>>(object: I): QueryChainsInfoResponse {
    const message = createBaseQueryChainsInfoResponse();
...
function createBaseQueryEpochChainsInfoRequest(): QueryEpochChainsInfoRequest {
  return { epochNum: 0, consumerIds: [] };
}

export const QueryEpochChainsInfoRequest: MessageFns<QueryEpochChainsInfoRequest> = {
  encode(message: QueryEpochChainsInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEpochChainsInfoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryEpochChainsInfoRequest>, I>>(base?: I): QueryEpochChainsInfoRequest {
    return QueryEpochChainsInfoRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEpochChainsInfoRequest>, I>>(object: I): QueryEpochChainsInfoRequest {
    const message = createBaseQueryEpochChainsInfoRequest();
...
export const QueryEpochChainsInfoResponse: MessageFns<QueryEpochChainsInfoResponse> = {
  encode(message: QueryEpochChainsInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.chainsInfo) {
      ChainInfo.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryEpochChainsInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryEpochChainsInfoResponse>, I>>(base?: I): QueryEpochChainsInfoResponse {
    return QueryEpochChainsInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEpochChainsInfoResponse>, I>>(object: I): QueryEpochChainsInfoResponse {
    const message = createBaseQueryEpochChainsInfoResponse();
    message.chainsInfo = object.chainsInfo?.map((e) => ChainInfo.fromPartial(e)) || [];
    return message;
  },
...
export const QueryListHeadersRequest: MessageFns<QueryListHeadersRequest> = {
  encode(message: QueryListHeadersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.consumerId !== "") {
      writer.uint32(10).string(message.consumerId);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryListHeadersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryListHeadersRequest>, I>>(base?: I): QueryListHeadersRequest {
    return QueryListHeadersRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryListHeadersRequest>, I>>(object: I): QueryListHeadersRequest {
    const message = createBaseQueryListHeadersRequest();
    message.consumerId = object.consumerId ?? "";
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
...
export const QueryListHeadersResponse: MessageFns<QueryListHeadersResponse> = {
  encode(message: QueryListHeadersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryListHeadersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryListHeadersResponse>, I>>(base?: I): QueryListHeadersResponse {
    return QueryListHeadersResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryListHeadersResponse>, I>>(object: I): QueryListHeadersResponse {
    const message = createBaseQueryListHeadersResponse();
    message.headers = object.headers?.map((e) => IndexedHeader.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageResponse.fromPartial(object.pagination)
      : undefined;
    return message;
...
function createBaseQueryListEpochHeadersRequest(): QueryListEpochHeadersRequest {
  return { epochNum: 0, consumerId: "" };
}

export const QueryListEpochHeadersRequest: MessageFns<QueryListEpochHeadersRequest> = {
  encode(message: QueryListEpochHeadersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
    if (message.consumerId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryListEpochHeadersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryListEpochHeadersRequest>, I>>(base?: I): QueryListEpochHeadersRequest {
    return QueryListEpochHeadersRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryListEpochHeadersRequest>, I>>(object: I): QueryListEpochHeadersRequest {
    const message = createBaseQueryListEpochHeadersRequest();
    message.epochNum = object.epochNum ?? 0;
    message.consumerId = object.consumerId ?? "";
    return message;
...
export const QueryListEpochHeadersResponse: MessageFns<QueryListEpochHeadersResponse> = {
  encode(message: QueryListEpochHeadersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.headers) {
      IndexedHeader.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryListEpochHeadersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<QueryListEpochHeadersResponse>, I>>(base?: I): QueryListEpochHeadersResponse {
...
export const QueryFinalizedChainInfoUntilHeightResponse: MessageFns<QueryFinalizedChainInfoUntilHeightResponse> = {
  encode(message: QueryFinalizedChainInfoUntilHeightResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.finalizedChainInfo !== undefined) {
      ChainInfo.encode(message.finalizedChainInfo, writer.uint32(10).fork()).join();
    }
    ...
    if (message.rawCheckpoint !== undefined) {
      RawCheckpoint.encode(message.rawCheckpoint, writer.uint32(26).fork()).join();
    }
    if (message.btcSubmissionKey !== undefined) {
      SubmissionKey.encode(message.btcSubmissionKey, writer.uint32(34).fork()).join();
    }
    if (message.proof !== undefined) {
      ProofFinalizedChainInfo.encode(message.proof, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
export interface Query {
   ...
   */
  EpochChainsInfo(request: QueryEpochChainsInfoRequest): Promise<QueryEpochChainsInfoResponse>;
  /**
   * ListHeaders queries the headers of a chain in Babylon's view, with
   * pagination support
   */
  ListHeaders(request: QueryListHeadersRequest): Promise<QueryListHeadersResponse>;
  /**
   * ListEpochHeaders queries the headers of a chain timestamped in a given
   * epoch of Babylon, with pagination support
   */
  ListEpochHeaders(request: QueryListEpochHeadersRequest): Promise<QueryListEpochHeadersResponse>;
...
export class QueryClientImpl implements Query {
  ...
  ChainList(request: QueryChainListRequest): Promise<QueryChainListResponse> {
    ...
    return promise.then((data) => QueryChainListResponse.decode(new BinaryReader(data)));
  }

  ChainsInfo(request: QueryChainsInfoRequest): Promise<QueryChainsInfoResponse> {
    const data = QueryChainsInfoRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ChainsInfo", data);
    return promise.then((data) => QueryChainsInfoResponse.decode(new BinaryReader(data)));
  }
  ...
  EpochChainsInfo(request: QueryEpochChainsInfoRequest): Promise<QueryEpochChainsInfoResponse> {
    ...
    return promise.then((data) => QueryEpochChainsInfoResponse.decode(new BinaryReader(data)));
  }

  ListHeaders(request: QueryListHeadersRequest): Promise<QueryListHeadersResponse> {
    const data = QueryListHeadersRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ListHeaders", data);
    return promise.then((data) => QueryListHeadersResponse.decode(new BinaryReader(data)));
  }
  ...
  ListEpochHeaders(request: QueryListEpochHeadersRequest): Promise<QueryListEpochHeadersResponse> {
    ...
    return promise.then((data) => QueryListEpochHeadersResponse.decode(new BinaryReader(data)));
  }
