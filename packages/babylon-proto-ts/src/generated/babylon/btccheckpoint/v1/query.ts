...
export const QueryBtcCheckpointInfoRequest: MessageFns<QueryBtcCheckpointInfoRequest> = {
  encode(message: QueryBtcCheckpointInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryBtcCheckpointInfoRequest>, I>>(base?: I): QueryBtcCheckpointInfoRequest {
...
export const QueryBtcCheckpointInfoResponse: MessageFns<QueryBtcCheckpointInfoResponse> = {
  encode(message: QueryBtcCheckpointInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.info !== undefined) {
      BTCCheckpointInfoResponse.encode(message.info, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryBtcCheckpointInfoResponse {
    return { info: isSet(object.info) ? BTCCheckpointInfoResponse.fromJSON(object.info) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<QueryBtcCheckpointInfoResponse>, I>>(base?: I): QueryBtcCheckpointInfoResponse {
    return QueryBtcCheckpointInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBtcCheckpointInfoResponse>, I>>(
    object: I,
...
export const QueryBtcCheckpointsInfoRequest: MessageFns<QueryBtcCheckpointsInfoRequest> = {
  encode(message: QueryBtcCheckpointsInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryBtcCheckpointsInfoRequest>, I>>(base?: I): QueryBtcCheckpointsInfoRequest {
    return QueryBtcCheckpointsInfoRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBtcCheckpointsInfoRequest>, I>>(
    object: I,
...
export const QueryBtcCheckpointsInfoResponse: MessageFns<QueryBtcCheckpointsInfoResponse> = {
  encode(message: QueryBtcCheckpointsInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryBtcCheckpointsInfoResponse {
    return {
      infoList: globalThis.Array.isArray(object?.infoList)
        ? object.infoList.map((e: any) => BTCCheckpointInfoResponse.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryBtcCheckpointsInfoResponse): unknown {
    ...
    if (message.infoList?.length) {
      obj.infoList = message.infoList.map((e) => BTCCheckpointInfoResponse.toJSON(e));
    }
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryBtcCheckpointsInfoResponse>, I>>(base?: I): QueryBtcCheckpointsInfoResponse {
    return QueryBtcCheckpointsInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBtcCheckpointsInfoResponse>, I>>(
    object: I,
...
export const QueryEpochSubmissionsRequest: MessageFns<QueryEpochSubmissionsRequest> = {
  encode(message: QueryEpochSubmissionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<QueryEpochSubmissionsRequest>, I>>(base?: I): QueryEpochSubmissionsRequest {
    return QueryEpochSubmissionsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEpochSubmissionsRequest>, I>>(object: I): QueryEpochSubmissionsRequest {
    const message = createBaseQueryEpochSubmissionsRequest();
    message.epochNum = object.epochNum ?? 0;
    return message;
  },
...
export const QueryEpochSubmissionsResponse: MessageFns<QueryEpochSubmissionsResponse> = {
  encode(message: QueryEpochSubmissionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryEpochSubmissionsResponse>, I>>(base?: I): QueryEpochSubmissionsResponse {
...
export const BTCCheckpointInfoResponse: MessageFns<BTCCheckpointInfoResponse> = {
  encode(message: BTCCheckpointInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): BTCCheckpointInfoResponse {
    return {
      ...
      bestSubmissionBtcBlockHash: isSet(object.bestSubmissionBtcBlockHash)
        ...
        : "",
      bestSubmissionTransactions: globalThis.Array.isArray(object?.bestSubmissionTransactions)
        ? object.bestSubmissionTransactions.map((e: any) => TransactionInfoResponse.fromJSON(e))
        : [],
      bestSubmissionVigilanteAddressList: globalThis.Array.isArray(object?.bestSubmissionVigilanteAddressList)
        ? object.bestSubmissionVigilanteAddressList.map((e: any) => CheckpointAddressesResponse.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: BTCCheckpointInfoResponse): unknown {
    ...
    if (message.bestSubmissionTransactions?.length) {
      obj.bestSubmissionTransactions = message.bestSubmissionTransactions.map((e) => TransactionInfoResponse.toJSON(e));
    }
    if (message.bestSubmissionVigilanteAddressList?.length) {
      obj.bestSubmissionVigilanteAddressList = message.bestSubmissionVigilanteAddressList.map((e) =>
  ...
  create<I extends Exact<DeepPartial<BTCCheckpointInfoResponse>, I>>(base?: I): BTCCheckpointInfoResponse {
    return BTCCheckpointInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCCheckpointInfoResponse>, I>>(object: I): BTCCheckpointInfoResponse {
    const message = createBaseBTCCheckpointInfoResponse();
    message.epochNumber = object.epochNumber ?? 0;
    message.bestSubmissionBtcBlockHeight = object.bestSubmissionBtcBlockHeight ?? 0;
...
export const TransactionInfoResponse: MessageFns<TransactionInfoResponse> = {
  encode(message: TransactionInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.index !== 0) {
  ...
  create<I extends Exact<DeepPartial<TransactionInfoResponse>, I>>(base?: I): TransactionInfoResponse {
    return TransactionInfoResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TransactionInfoResponse>, I>>(object: I): TransactionInfoResponse {
    const message = createBaseTransactionInfoResponse();
...
export const CheckpointAddressesResponse: MessageFns<CheckpointAddressesResponse> = {
  encode(message: CheckpointAddressesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<CheckpointAddressesResponse>, I>>(base?: I): CheckpointAddressesResponse {
    return CheckpointAddressesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CheckpointAddressesResponse>, I>>(object: I): CheckpointAddressesResponse {
    const message = createBaseCheckpointAddressesResponse();
...
function createBaseSubmissionKeyResponse(): SubmissionKeyResponse {
  return { firstTxBlockHash: "", firstTxIndex: 0, secondTxBlockHash: "", secondTxIndex: 0 };
}

export const SubmissionKeyResponse: MessageFns<SubmissionKeyResponse> = {
  encode(message: SubmissionKeyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): SubmissionKeyResponse {
    return {
      firstTxBlockHash: isSet(object.firstTxBlockHash) ? globalThis.String(object.firstTxBlockHash) : "",
      firstTxIndex: isSet(object.firstTxIndex) ? globalThis.Number(object.firstTxIndex) : 0,
      secondTxBlockHash: isSet(object.secondTxBlockHash) ? globalThis.String(object.secondTxBlockHash) : "",
      secondTxIndex: isSet(object.secondTxIndex) ? globalThis.Number(object.secondTxIndex) : 0,
    };
  },
  ...
  create<I extends Exact<DeepPartial<SubmissionKeyResponse>, I>>(base?: I): SubmissionKeyResponse {
    return SubmissionKeyResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubmissionKeyResponse>, I>>(object: I): SubmissionKeyResponse {
    const message = createBaseSubmissionKeyResponse();
