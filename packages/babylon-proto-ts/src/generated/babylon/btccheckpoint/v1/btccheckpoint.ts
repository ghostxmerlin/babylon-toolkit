...
export const BTCSpvProof: MessageFns<BTCSpvProof> = {
  encode(message: BTCSpvProof, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromPartial<I extends Exact<DeepPartial<BTCSpvProof>, I>>(object: I): BTCSpvProof {
    const message = createBaseBTCSpvProof();
    ...
    message.confirmingBtcHeader = object.confirmingBtcHeader ?? new Uint8Array(0);
    return message;
  },
};
...
export const SubmissionKey: MessageFns<SubmissionKey> = {
  encode(message: SubmissionKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): SubmissionKey {
    return { key: globalThis.Array.isArray(object?.key) ? object.key.map((e: any) => TransactionKey.fromJSON(e)) : [] };
  },
  ...
  create<I extends Exact<DeepPartial<SubmissionKey>, I>>(base?: I): SubmissionKey {
    return SubmissionKey.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubmissionKey>, I>>(object: I): SubmissionKey {
    const message = createBaseSubmissionKey();
...
export const SubmissionData: MessageFns<SubmissionData> = {
  encode(message: SubmissionData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.vigilanteAddresses !== undefined) {
      CheckpointAddresses.encode(message.vigilanteAddresses, writer.uint32(10).fork()).join();
    }
  ...
  toJSON(message: SubmissionData): unknown {
    const obj: any = {};
    if (message.vigilanteAddresses !== undefined) {
      obj.vigilanteAddresses = CheckpointAddresses.toJSON(message.vigilanteAddresses);
    }
  ...
  create<I extends Exact<DeepPartial<SubmissionData>, I>>(base?: I): SubmissionData {
    return SubmissionData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SubmissionData>, I>>(object: I): SubmissionData {
    const message = createBaseSubmissionData();
...
export const EpochData: MessageFns<EpochData> = {
  encode(message: EpochData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): EpochData {
    return {
      keys: globalThis.Array.isArray(object?.keys) ? object.keys.map((e: any) => SubmissionKey.fromJSON(e)) : [],
...
export const CheckpointAddresses: MessageFns<CheckpointAddresses> = {
  encode(message: CheckpointAddresses, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<CheckpointAddresses>, I>>(base?: I): CheckpointAddresses {
    return CheckpointAddresses.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CheckpointAddresses>, I>>(object: I): CheckpointAddresses {
    const message = createBaseCheckpointAddresses();
...
export const BTCCheckpointInfo: MessageFns<BTCCheckpointInfo> = {
  encode(message: BTCCheckpointInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): BTCCheckpointInfo {
    return {
      ...
      bestSubmissionTransactions: globalThis.Array.isArray(object?.bestSubmissionTransactions)
        ? object.bestSubmissionTransactions.map((e: any) => TransactionInfo.fromJSON(e))
        : [],
      bestSubmissionVigilanteAddressList: globalThis.Array.isArray(object?.bestSubmissionVigilanteAddressList)
        ? object.bestSubmissionVigilanteAddressList.map((e: any) => CheckpointAddresses.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: BTCCheckpointInfo): unknown {
    ...
    if (message.bestSubmissionTransactions?.length) {
      obj.bestSubmissionTransactions = message.bestSubmissionTransactions.map((e) => TransactionInfo.toJSON(e));
    }
  ...
  create<I extends Exact<DeepPartial<BTCCheckpointInfo>, I>>(base?: I): BTCCheckpointInfo {
    return BTCCheckpointInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCCheckpointInfo>, I>>(object: I): BTCCheckpointInfo {
    const message = createBaseBTCCheckpointInfo();
    message.epochNumber = object.epochNumber ?? 0;
    message.bestSubmissionBtcBlockHeight = object.bestSubmissionBtcBlockHeight ?? 0;
    message.bestSubmissionBtcBlockHash = object.bestSubmissionBtcBlockHash ?? new Uint8Array(0);
