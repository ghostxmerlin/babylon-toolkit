...
import { CheckpointStatus, checkpointStatusFromJSON, checkpointStatusToJSON } from "./checkpoint";
...
export const QueryRawCheckpointListRequest: MessageFns<QueryRawCheckpointListRequest> = {
  encode(message: QueryRawCheckpointListRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.status !== 0) {
  ...
  fromJSON(object: any): QueryRawCheckpointListRequest {
    return {
      status: isSet(object.status) ? checkpointStatusFromJSON(object.status) : 0,
  ...
  create<I extends Exact<DeepPartial<QueryRawCheckpointListRequest>, I>>(base?: I): QueryRawCheckpointListRequest {
...
export const QueryRawCheckpointListResponse: MessageFns<QueryRawCheckpointListResponse> = {
  encode(message: QueryRawCheckpointListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rawCheckpoints) {
      RawCheckpointWithMetaResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  fromJSON(object: any): QueryRawCheckpointListResponse {
    return {
      rawCheckpoints: globalThis.Array.isArray(object?.rawCheckpoints)
        ? object.rawCheckpoints.map((e: any) => RawCheckpointWithMetaResponse.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryRawCheckpointListResponse): unknown {
    ...
    if (message.rawCheckpoints?.length) {
      obj.rawCheckpoints = message.rawCheckpoints.map((e) => RawCheckpointWithMetaResponse.toJSON(e));
    }
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryRawCheckpointListResponse>, I>>(base?: I): QueryRawCheckpointListResponse {
    return QueryRawCheckpointListResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRawCheckpointListResponse>, I>>(
    object: I,
...
export const QueryRawCheckpointRequest: MessageFns<QueryRawCheckpointRequest> = {
  encode(message: QueryRawCheckpointRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryRawCheckpointRequest>, I>>(base?: I): QueryRawCheckpointRequest {
    return QueryRawCheckpointRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRawCheckpointRequest>, I>>(object: I): QueryRawCheckpointRequest {
    const message = createBaseQueryRawCheckpointRequest();
...
export const QueryRawCheckpointResponse: MessageFns<QueryRawCheckpointResponse> = {
  encode(message: QueryRawCheckpointResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rawCheckpoint !== undefined) {
      RawCheckpointWithMetaResponse.encode(message.rawCheckpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: QueryRawCheckpointResponse): unknown {
    const obj: any = {};
    if (message.rawCheckpoint !== undefined) {
      obj.rawCheckpoint = RawCheckpointWithMetaResponse.toJSON(message.rawCheckpoint);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryRawCheckpointResponse>, I>>(base?: I): QueryRawCheckpointResponse {
    return QueryRawCheckpointResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRawCheckpointResponse>, I>>(object: I): QueryRawCheckpointResponse {
    const message = createBaseQueryRawCheckpointResponse();
...
export const QueryRawCheckpointsRequest: MessageFns<QueryRawCheckpointsRequest> = {
  encode(message: QueryRawCheckpointsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryRawCheckpointsRequest>, I>>(base?: I): QueryRawCheckpointsRequest {
    return QueryRawCheckpointsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRawCheckpointsRequest>, I>>(object: I): QueryRawCheckpointsRequest {
    const message = createBaseQueryRawCheckpointsRequest();
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
      : undefined;
...
export const QueryRawCheckpointsResponse: MessageFns<QueryRawCheckpointsResponse> = {
  encode(message: QueryRawCheckpointsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.rawCheckpoints) {
      RawCheckpointWithMetaResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryRawCheckpointsResponse>, I>>(base?: I): QueryRawCheckpointsResponse {
    return QueryRawCheckpointsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRawCheckpointsResponse>, I>>(object: I): QueryRawCheckpointsResponse {
    const message = createBaseQueryRawCheckpointsResponse();
    message.rawCheckpoints = object.rawCheckpoints?.map((e) => RawCheckpointWithMetaResponse.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageResponse.fromPartial(object.pagination)
...
export const QueryBlsPublicKeyListRequest: MessageFns<QueryBlsPublicKeyListRequest> = {
  encode(message: QueryBlsPublicKeyListRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryBlsPublicKeyListRequest>, I>>(base?: I): QueryBlsPublicKeyListRequest {
    return QueryBlsPublicKeyListRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBlsPublicKeyListRequest>, I>>(object: I): QueryBlsPublicKeyListRequest {
    const message = createBaseQueryBlsPublicKeyListRequest();
    message.epochNum = object.epochNum ?? 0;
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
...
export const BlsPublicKeyListResponse: MessageFns<BlsPublicKeyListResponse> = {
  encode(message: BlsPublicKeyListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlsPublicKeyListResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): BlsPublicKeyListResponse {
    return {
      ...
      blsPubKeyHex: isSet(object.blsPubKeyHex) ? globalThis.String(object.blsPubKeyHex) : "",
  ...
  create<I extends Exact<DeepPartial<BlsPublicKeyListResponse>, I>>(base?: I): BlsPublicKeyListResponse {
    return BlsPublicKeyListResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BlsPublicKeyListResponse>, I>>(object: I): BlsPublicKeyListResponse {
    const message = createBaseBlsPublicKeyListResponse();
...
export const QueryBlsPublicKeyListResponse: MessageFns<QueryBlsPublicKeyListResponse> = {
  encode(message: QueryBlsPublicKeyListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.validatorWithBlsKeys.push(BlsPublicKeyListResponse.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): QueryBlsPublicKeyListResponse {
    return {
      validatorWithBlsKeys: globalThis.Array.isArray(object?.validatorWithBlsKeys)
        ? object.validatorWithBlsKeys.map((e: any) => BlsPublicKeyListResponse.fromJSON(e))
        : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  toJSON(message: QueryBlsPublicKeyListResponse): unknown {
    ...
    if (message.validatorWithBlsKeys?.length) {
      obj.validatorWithBlsKeys = message.validatorWithBlsKeys.map((e) => BlsPublicKeyListResponse.toJSON(e));
    }
    if (message.pagination !== undefined) {
      obj.pagination = PageResponse.toJSON(message.pagination);
    }
  ...
  create<I extends Exact<DeepPartial<QueryBlsPublicKeyListResponse>, I>>(base?: I): QueryBlsPublicKeyListResponse {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryBlsPublicKeyListResponse>, I>>(
    ...
    const message = createBaseQueryBlsPublicKeyListResponse();
    message.validatorWithBlsKeys = object.validatorWithBlsKeys?.map((e) => BlsPublicKeyListResponse.fromPartial(e)) ||
      [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageResponse.fromPartial(object.pagination)
      : undefined;
...
export const QueryEpochStatusRequest: MessageFns<QueryEpochStatusRequest> = {
  encode(message: QueryEpochStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<QueryEpochStatusRequest>, I>>(base?: I): QueryEpochStatusRequest {
    return QueryEpochStatusRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEpochStatusRequest>, I>>(object: I): QueryEpochStatusRequest {
    const message = createBaseQueryEpochStatusRequest();
    message.epochNum = object.epochNum ?? 0;
    return message;
  },
...
export const QueryEpochStatusResponse: MessageFns<QueryEpochStatusResponse> = {
  encode(message: QueryEpochStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.status !== 0) {
      writer.uint32(8).int32(message.status);
    }
    return writer;
  ...
  fromJSON(object: any): QueryEpochStatusResponse {
    return { status: isSet(object.status) ? checkpointStatusFromJSON(object.status) : 0 };
  },
  ...
  create<I extends Exact<DeepPartial<QueryEpochStatusResponse>, I>>(base?: I): QueryEpochStatusResponse {
    return QueryEpochStatusResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryEpochStatusResponse>, I>>(object: I): QueryEpochStatusResponse {
    const message = createBaseQueryEpochStatusResponse();
    message.status = object.status ?? 0;
    return message;
  },
...
export const QueryRecentEpochStatusCountRequest: MessageFns<QueryRecentEpochStatusCountRequest> = {
  encode(message: QueryRecentEpochStatusCountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryRecentEpochStatusCountRequest {
    return { epochCount: isSet(object.epochCount) ? globalThis.Number(object.epochCount) : 0 };
  },
  ...
  create<I extends Exact<DeepPartial<QueryRecentEpochStatusCountRequest>, I>>(
    ...
    return QueryRecentEpochStatusCountRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRecentEpochStatusCountRequest>, I>>(
    object: I,
  ): QueryRecentEpochStatusCountRequest {
    const message = createBaseQueryRecentEpochStatusCountRequest();
...
export const QueryRecentEpochStatusCountResponse: MessageFns<QueryRecentEpochStatusCountResponse> = {
  encode(message: QueryRecentEpochStatusCountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.statusCount).forEach(([key, value]) => {
      QueryRecentEpochStatusCountResponse_StatusCountEntry.encode({ key: key as any, value }, writer.uint32(26).fork())
        .join();
    });
    return writer;
  },
  ...
  fromJSON(object: any): QueryRecentEpochStatusCountResponse {
    return {
      tipEpoch: isSet(object.tipEpoch) ? globalThis.Number(object.tipEpoch) : 0,
  ...
  create<I extends Exact<DeepPartial<QueryRecentEpochStatusCountResponse>, I>>(
    base?: I,
  ): QueryRecentEpochStatusCountResponse {
    return QueryRecentEpochStatusCountResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRecentEpochStatusCountResponse>, I>>(
    object: I,
  ): QueryRecentEpochStatusCountResponse {
    const message = createBaseQueryRecentEpochStatusCountResponse();
...
export const QueryRecentEpochStatusCountResponse_StatusCountEntry: MessageFns<
...
> = {
  ...
  fromJSON(object: any): QueryRecentEpochStatusCountResponse_StatusCountEntry {
    return {
  ...
  toJSON(message: QueryRecentEpochStatusCountResponse_StatusCountEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<QueryRecentEpochStatusCountResponse_StatusCountEntry>, I>>(
    base?: I,
  ): QueryRecentEpochStatusCountResponse_StatusCountEntry {
    return QueryRecentEpochStatusCountResponse_StatusCountEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryRecentEpochStatusCountResponse_StatusCountEntry>, I>>(
    object: I,
  ): QueryRecentEpochStatusCountResponse_StatusCountEntry {
    const message = createBaseQueryRecentEpochStatusCountResponse_StatusCountEntry();
...
export const QueryLastCheckpointWithStatusRequest: MessageFns<QueryLastCheckpointWithStatusRequest> = {
  encode(message: QueryLastCheckpointWithStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.status !== 0) {
      writer.uint32(8).int32(message.status);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<QueryLastCheckpointWithStatusRequest>, I>>(
    base?: I,
  ): QueryLastCheckpointWithStatusRequest {
    return QueryLastCheckpointWithStatusRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryLastCheckpointWithStatusRequest>, I>>(
    object: I,
  ): QueryLastCheckpointWithStatusRequest {
    const message = createBaseQueryLastCheckpointWithStatusRequest();
    message.status = object.status ?? 0;
...
export const QueryLastCheckpointWithStatusResponse: MessageFns<QueryLastCheckpointWithStatusResponse> = {
  encode(message: QueryLastCheckpointWithStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rawCheckpoint !== undefined) {
      RawCheckpointResponse.encode(message.rawCheckpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryLastCheckpointWithStatusResponse {
    return {
      rawCheckpoint: isSet(object.rawCheckpoint) ? RawCheckpointResponse.fromJSON(object.rawCheckpoint) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QueryLastCheckpointWithStatusResponse>, I>>(
    base?: I,
  ): QueryLastCheckpointWithStatusResponse {
    return QueryLastCheckpointWithStatusResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryLastCheckpointWithStatusResponse>, I>>(
    object: I,
  ): QueryLastCheckpointWithStatusResponse {
    const message = createBaseQueryLastCheckpointWithStatusResponse();
    message.rawCheckpoint = (object.rawCheckpoint !== undefined && object.rawCheckpoint !== null)
...
function createBaseRawCheckpointResponse(): RawCheckpointResponse {
  return { epochNum: 0, blockHashHex: "", bitmap: new Uint8Array(0), blsMultiSig: new Uint8Array(0) };
}

export const RawCheckpointResponse: MessageFns<RawCheckpointResponse> = {
  encode(message: RawCheckpointResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
  ...
  fromJSON(object: any): RawCheckpointResponse {
    return {
      epochNum: isSet(object.epochNum) ? globalThis.Number(object.epochNum) : 0,
      blockHashHex: isSet(object.blockHashHex) ? globalThis.String(object.blockHashHex) : "",
      bitmap: isSet(object.bitmap) ? bytesFromBase64(object.bitmap) : new Uint8Array(0),
      blsMultiSig: isSet(object.blsMultiSig) ? bytesFromBase64(object.blsMultiSig) : new Uint8Array(0),
    };
  },
  ...
  create<I extends Exact<DeepPartial<RawCheckpointResponse>, I>>(base?: I): RawCheckpointResponse {
    return RawCheckpointResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RawCheckpointResponse>, I>>(object: I): RawCheckpointResponse {
    const message = createBaseRawCheckpointResponse();
    message.epochNum = object.epochNum ?? 0;
...
export const CheckpointStateUpdateResponse: MessageFns<CheckpointStateUpdateResponse> = {
  encode(message: CheckpointStateUpdateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  create<I extends Exact<DeepPartial<CheckpointStateUpdateResponse>, I>>(base?: I): CheckpointStateUpdateResponse {
...
function createBaseRawCheckpointWithMetaResponse(): RawCheckpointWithMetaResponse {
  return { ckpt: undefined, status: 0, statusDesc: "", blsAggrPk: new Uint8Array(0), powerSum: 0, lifecycle: [] };
}

export const RawCheckpointWithMetaResponse: MessageFns<RawCheckpointWithMetaResponse> = {
  encode(message: RawCheckpointWithMetaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ckpt !== undefined) {
      RawCheckpointResponse.encode(message.ckpt, writer.uint32(10).fork()).join();
    }
    if (message.status !== 0) {
    ...
    for (const v of message.lifecycle) {
      CheckpointStateUpdateResponse.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): RawCheckpointWithMetaResponse {
    return {
      ckpt: isSet(object.ckpt) ? RawCheckpointResponse.fromJSON(object.ckpt) : undefined,
      status: isSet(object.status) ? checkpointStatusFromJSON(object.status) : 0,
      statusDesc: isSet(object.statusDesc) ? globalThis.String(object.statusDesc) : "",
      blsAggrPk: isSet(object.blsAggrPk) ? bytesFromBase64(object.blsAggrPk) : new Uint8Array(0),
      powerSum: isSet(object.powerSum) ? globalThis.Number(object.powerSum) : 0,
      lifecycle: globalThis.Array.isArray(object?.lifecycle)
        ? object.lifecycle.map((e: any) => CheckpointStateUpdateResponse.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: RawCheckpointWithMetaResponse): unknown {
    ...
    if (message.lifecycle?.length) {
      obj.lifecycle = message.lifecycle.map((e) => CheckpointStateUpdateResponse.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RawCheckpointWithMetaResponse>, I>>(base?: I): RawCheckpointWithMetaResponse {
...
export class QueryClientImpl implements Query {
  ...
  RecentEpochStatusCount(request: QueryRecentEpochStatusCountRequest): Promise<QueryRecentEpochStatusCountResponse> {
    ...
    const promise = this.rpc.request(this.service, "RecentEpochStatusCount", data);
  ...
  LastCheckpointWithStatus(
    ...
    const promise = this.rpc.request(this.service, "LastCheckpointWithStatus", data);
