...
function createBaseRawCheckpoint(): RawCheckpoint {
  return { epochNum: 0, blockHash: new Uint8Array(0), bitmap: new Uint8Array(0), blsMultiSig: new Uint8Array(0) };
}

export const RawCheckpoint: MessageFns<RawCheckpoint> = {
  encode(message: RawCheckpoint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<RawCheckpoint>, I>>(base?: I): RawCheckpoint {
    return RawCheckpoint.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RawCheckpoint>, I>>(object: I): RawCheckpoint {
    const message = createBaseRawCheckpoint();
...
function createBaseRawCheckpointWithMeta(): RawCheckpointWithMeta {
  return { ckpt: undefined, status: 0, blsAggrPk: new Uint8Array(0), powerSum: 0, lifecycle: [] };
}

export const RawCheckpointWithMeta: MessageFns<RawCheckpointWithMeta> = {
  encode(message: RawCheckpointWithMeta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): RawCheckpointWithMeta {
    return {
      ckpt: isSet(object.ckpt) ? RawCheckpoint.fromJSON(object.ckpt) : undefined,
  ...
  toJSON(message: RawCheckpointWithMeta): unknown {
    ...
    if (message.lifecycle?.length) {
      obj.lifecycle = message.lifecycle.map((e) => CheckpointStateUpdate.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RawCheckpointWithMeta>, I>>(base?: I): RawCheckpointWithMeta {
    return RawCheckpointWithMeta.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RawCheckpointWithMeta>, I>>(object: I): RawCheckpointWithMeta {
    const message = createBaseRawCheckpointWithMeta();
...
export const MsgInjectedCheckpoint: MessageFns<MsgInjectedCheckpoint> = {
  encode(message: MsgInjectedCheckpoint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.extendedCommitInfo !== undefined) {
      ExtendedCommitInfo.encode(message.extendedCommitInfo, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: MsgInjectedCheckpoint): unknown {
    ...
    if (message.extendedCommitInfo !== undefined) {
      obj.extendedCommitInfo = ExtendedCommitInfo.toJSON(message.extendedCommitInfo);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgInjectedCheckpoint>, I>>(object: I): MsgInjectedCheckpoint {
    ...
    message.ckpt = (object.ckpt !== undefined && object.ckpt !== null)
      ...
      : undefined;
    message.extendedCommitInfo = (object.extendedCommitInfo !== undefined && object.extendedCommitInfo !== null)
...
export const CheckpointStateUpdate: MessageFns<CheckpointStateUpdate> = {
  encode(message: CheckpointStateUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  create<I extends Exact<DeepPartial<CheckpointStateUpdate>, I>>(base?: I): CheckpointStateUpdate {
    return CheckpointStateUpdate.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CheckpointStateUpdate>, I>>(object: I): CheckpointStateUpdate {
    const message = createBaseCheckpointStateUpdate();
...
export const BlsSig: MessageFns<BlsSig> = {
  encode(message: BlsSig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNum !== 0) {
      writer.uint32(8).uint64(message.epochNum);
    }
    if (message.blockHash.length !== 0) {
  ...
  fromJSON(object: any): BlsSig {
    return {
      epochNum: isSet(object.epochNum) ? globalThis.Number(object.epochNum) : 0,
      blockHash: isSet(object.blockHash) ? bytesFromBase64(object.blockHash) : new Uint8Array(0),
      blsSig: isSet(object.blsSig) ? bytesFromBase64(object.blsSig) : new Uint8Array(0),
