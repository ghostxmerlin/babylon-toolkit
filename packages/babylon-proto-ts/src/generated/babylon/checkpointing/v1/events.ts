...
export const EventCheckpointAccumulating: MessageFns<EventCheckpointAccumulating> = {
  encode(message: EventCheckpointAccumulating, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): EventCheckpointAccumulating {
    return { checkpoint: isSet(object.checkpoint) ? RawCheckpointWithMeta.fromJSON(object.checkpoint) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<EventCheckpointAccumulating>, I>>(base?: I): EventCheckpointAccumulating {
    return EventCheckpointAccumulating.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointAccumulating>, I>>(object: I): EventCheckpointAccumulating {
    const message = createBaseEventCheckpointAccumulating();
...
export const EventCheckpointSealed: MessageFns<EventCheckpointSealed> = {
  encode(message: EventCheckpointSealed, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventCheckpointSealed>, I>>(base?: I): EventCheckpointSealed {
    return EventCheckpointSealed.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointSealed>, I>>(object: I): EventCheckpointSealed {
    const message = createBaseEventCheckpointSealed();
    message.checkpoint = (object.checkpoint !== undefined && object.checkpoint !== null)
      ? RawCheckpointWithMeta.fromPartial(object.checkpoint)
      : undefined;
...
export const EventCheckpointSubmitted: MessageFns<EventCheckpointSubmitted> = {
  encode(message: EventCheckpointSubmitted, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventCheckpointSubmitted>, I>>(base?: I): EventCheckpointSubmitted {
    return EventCheckpointSubmitted.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointSubmitted>, I>>(object: I): EventCheckpointSubmitted {
    const message = createBaseEventCheckpointSubmitted();
    message.checkpoint = (object.checkpoint !== undefined && object.checkpoint !== null)
      ? RawCheckpointWithMeta.fromPartial(object.checkpoint)
      : undefined;
...
export const EventCheckpointConfirmed: MessageFns<EventCheckpointConfirmed> = {
  encode(message: EventCheckpointConfirmed, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventCheckpointConfirmed>, I>>(base?: I): EventCheckpointConfirmed {
    return EventCheckpointConfirmed.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointConfirmed>, I>>(object: I): EventCheckpointConfirmed {
    const message = createBaseEventCheckpointConfirmed();
    message.checkpoint = (object.checkpoint !== undefined && object.checkpoint !== null)
      ? RawCheckpointWithMeta.fromPartial(object.checkpoint)
      : undefined;
...
export const EventCheckpointFinalized: MessageFns<EventCheckpointFinalized> = {
  encode(message: EventCheckpointFinalized, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventCheckpointFinalized>, I>>(base?: I): EventCheckpointFinalized {
    return EventCheckpointFinalized.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointFinalized>, I>>(object: I): EventCheckpointFinalized {
    const message = createBaseEventCheckpointFinalized();
    message.checkpoint = (object.checkpoint !== undefined && object.checkpoint !== null)
      ? RawCheckpointWithMeta.fromPartial(object.checkpoint)
      : undefined;
...
export const EventCheckpointForgotten: MessageFns<EventCheckpointForgotten> = {
  encode(message: EventCheckpointForgotten, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.checkpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.checkpoint, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventCheckpointForgotten>, I>>(base?: I): EventCheckpointForgotten {
    return EventCheckpointForgotten.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventCheckpointForgotten>, I>>(object: I): EventCheckpointForgotten {
    const message = createBaseEventCheckpointForgotten();
    message.checkpoint = (object.checkpoint !== undefined && object.checkpoint !== null)
      ? RawCheckpointWithMeta.fromPartial(object.checkpoint)
      : undefined;
...
export const EventConflictingCheckpoint: MessageFns<EventConflictingCheckpoint> = {
  encode(message: EventConflictingCheckpoint, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.conflictingCheckpoint !== undefined) {
      RawCheckpoint.encode(message.conflictingCheckpoint, writer.uint32(10).fork()).join();
    }
    if (message.localCheckpoint !== undefined) {
      RawCheckpointWithMeta.encode(message.localCheckpoint, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: EventConflictingCheckpoint): unknown {
    const obj: any = {};
    if (message.conflictingCheckpoint !== undefined) {
      obj.conflictingCheckpoint = RawCheckpoint.toJSON(message.conflictingCheckpoint);
    }
    if (message.localCheckpoint !== undefined) {
      obj.localCheckpoint = RawCheckpointWithMeta.toJSON(message.localCheckpoint);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EventConflictingCheckpoint>, I>>(base?: I): EventConflictingCheckpoint {
    return EventConflictingCheckpoint.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventConflictingCheckpoint>, I>>(object: I): EventConflictingCheckpoint {
    const message = createBaseEventConflictingCheckpoint();
    message.conflictingCheckpoint =
      (object.conflictingCheckpoint !== undefined && object.conflictingCheckpoint !== null)
        ...
        : undefined;
    message.localCheckpoint = (object.localCheckpoint !== undefined && object.localCheckpoint !== null)
