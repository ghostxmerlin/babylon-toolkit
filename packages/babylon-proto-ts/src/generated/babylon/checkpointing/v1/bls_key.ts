...
export const BlsKey: MessageFns<BlsKey> = {
  encode(message: BlsKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): BlsKey {
    return {
      ...
      pop: isSet(object.pop) ? ProofOfPossession.fromJSON(object.pop) : undefined,
    };
  },
...
export const ProofOfPossession: MessageFns<ProofOfPossession> = {
  encode(message: ProofOfPossession, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): ProofOfPossession {
    return {
      ed25519Sig: isSet(object.ed25519Sig) ? bytesFromBase64(object.ed25519Sig) : new Uint8Array(0),
  ...
  create<I extends Exact<DeepPartial<ProofOfPossession>, I>>(base?: I): ProofOfPossession {
    return ProofOfPossession.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProofOfPossession>, I>>(object: I): ProofOfPossession {
    const message = createBaseProofOfPossession();
...
export const ValidatorWithBlsKeySet: MessageFns<ValidatorWithBlsKeySet> = {
  encode(message: ValidatorWithBlsKeySet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<ValidatorWithBlsKeySet>, I>>(base?: I): ValidatorWithBlsKeySet {
    return ValidatorWithBlsKeySet.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorWithBlsKeySet>, I>>(object: I): ValidatorWithBlsKeySet {
    const message = createBaseValidatorWithBlsKeySet();
...
export const ValidatorWithBlsKey: MessageFns<ValidatorWithBlsKey> = {
  encode(message: ValidatorWithBlsKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): ValidatorWithBlsKey {
    return {
      ...
      blsPubKey: isSet(object.blsPubKey) ? bytesFromBase64(object.blsPubKey) : new Uint8Array(0),
  ...
  create<I extends Exact<DeepPartial<ValidatorWithBlsKey>, I>>(base?: I): ValidatorWithBlsKey {
    return ValidatorWithBlsKey.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorWithBlsKey>, I>>(object: I): ValidatorWithBlsKey {
    const message = createBaseValidatorWithBlsKey();
