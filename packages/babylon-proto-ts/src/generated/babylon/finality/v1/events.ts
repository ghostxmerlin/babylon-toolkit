...
export const EventSlashedFinalityProvider: MessageFns<EventSlashedFinalityProvider> = {
  encode(message: EventSlashedFinalityProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventSlashedFinalityProvider {
  ...
  create<I extends Exact<DeepPartial<EventSlashedFinalityProvider>, I>>(base?: I): EventSlashedFinalityProvider {
    return EventSlashedFinalityProvider.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventSlashedFinalityProvider>, I>>(object: I): EventSlashedFinalityProvider {
    const message = createBaseEventSlashedFinalityProvider();
...
export const EventJailedFinalityProvider: MessageFns<EventJailedFinalityProvider> = {
  encode(message: EventJailedFinalityProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventJailedFinalityProvider {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<EventJailedFinalityProvider>, I>>(base?: I): EventJailedFinalityProvider {
    return EventJailedFinalityProvider.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventJailedFinalityProvider>, I>>(object: I): EventJailedFinalityProvider {
    const message = createBaseEventJailedFinalityProvider();
