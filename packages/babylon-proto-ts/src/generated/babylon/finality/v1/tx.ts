...
export const MsgCommitPubRandList: MessageFns<MsgCommitPubRandList> = {
  encode(message: MsgCommitPubRandList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCommitPubRandList {
  ...
  create<I extends Exact<DeepPartial<MsgCommitPubRandList>, I>>(base?: I): MsgCommitPubRandList {
    return MsgCommitPubRandList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgCommitPubRandList>, I>>(object: I): MsgCommitPubRandList {
    const message = createBaseMsgCommitPubRandList();
...
export const MsgCommitPubRandListResponse: MessageFns<MsgCommitPubRandListResponse> = {
  encode(_: MsgCommitPubRandListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgCommitPubRandListResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<MsgCommitPubRandListResponse>, I>>(base?: I): MsgCommitPubRandListResponse {
    return MsgCommitPubRandListResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgCommitPubRandListResponse>, I>>(_: I): MsgCommitPubRandListResponse {
    const message = createBaseMsgCommitPubRandListResponse();
    return message;
  },
};
...
export const MsgAddFinalitySig: MessageFns<MsgAddFinalitySig> = {
  encode(message: MsgAddFinalitySig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signer !== "") {
      writer.uint32(10).string(message.signer);
    }
    if (message.fpBtcPk.length !== 0) {
  ...
  fromJSON(object: any): MsgAddFinalitySig {
    return {
      ...
      blockAppHash: isSet(object.blockAppHash) ? bytesFromBase64(object.blockAppHash) : new Uint8Array(0),
  ...
  create<I extends Exact<DeepPartial<MsgAddFinalitySig>, I>>(base?: I): MsgAddFinalitySig {
    return MsgAddFinalitySig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAddFinalitySig>, I>>(object: I): MsgAddFinalitySig {
    const message = createBaseMsgAddFinalitySig();
    message.signer = object.signer ?? "";
    message.fpBtcPk = object.fpBtcPk ?? new Uint8Array(0);
...
export const MsgAddFinalitySigResponse: MessageFns<MsgAddFinalitySigResponse> = {
  encode(_: MsgAddFinalitySigResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddFinalitySigResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<MsgAddFinalitySigResponse>, I>>(base?: I): MsgAddFinalitySigResponse {
    return MsgAddFinalitySigResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgAddFinalitySigResponse>, I>>(_: I): MsgAddFinalitySigResponse {
    const message = createBaseMsgAddFinalitySigResponse();
    return message;
  },
};
...
export const MsgUnjailFinalityProvider: MessageFns<MsgUnjailFinalityProvider> = {
  encode(message: MsgUnjailFinalityProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.signer !== "") {
      writer.uint32(10).string(message.signer);
    }
    if (message.fpBtcPk.length !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUnjailFinalityProvider {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<MsgUnjailFinalityProvider>, I>>(base?: I): MsgUnjailFinalityProvider {
    return MsgUnjailFinalityProvider.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgUnjailFinalityProvider>, I>>(object: I): MsgUnjailFinalityProvider {
    const message = createBaseMsgUnjailFinalityProvider();
    message.signer = object.signer ?? "";
    message.fpBtcPk = object.fpBtcPk ?? new Uint8Array(0);
    return message;
...
export const MsgUnjailFinalityProviderResponse: MessageFns<MsgUnjailFinalityProviderResponse> = {
  encode(_: MsgUnjailFinalityProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUnjailFinalityProviderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUnjailFinalityProviderResponse>, I>>(
    _: I,
  ): MsgUnjailFinalityProviderResponse {
    const message = createBaseMsgUnjailFinalityProviderResponse();
    return message;
...
export const MsgEquivocationEvidence: MessageFns<MsgEquivocationEvidence> = {
  encode(message: MsgEquivocationEvidence, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.canonicalAppHash.length !== 0) {
      writer.uint32(42).bytes(message.canonicalAppHash);
    }
    if (message.forkAppHash.length !== 0) {
      writer.uint32(50).bytes(message.forkAppHash);
    }
    if (message.canonicalFinalitySig.length !== 0) {
      writer.uint32(58).bytes(message.canonicalFinalitySig);
    }
    if (message.forkFinalitySig.length !== 0) {
      writer.uint32(66).bytes(message.forkFinalitySig);
    }
    return writer;
  },
...
export const MsgResumeFinalityProposal: MessageFns<MsgResumeFinalityProposal> = {
  encode(message: MsgResumeFinalityProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    for (const v of message.fpPksHex) {
      writer.uint32(18).string(v!);
    }
    if (message.haltingHeight !== 0) {
      writer.uint32(24).uint32(message.haltingHeight);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgResumeFinalityProposal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgResumeFinalityProposal();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.fpPksHex.push(reader.string());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.haltingHeight = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MsgResumeFinalityProposal {
    return {
      authority: isSet(object.authority) ? globalThis.String(object.authority) : "",
      fpPksHex: globalThis.Array.isArray(object?.fpPksHex) ? object.fpPksHex.map((e: any) => globalThis.String(e)) : [],
      haltingHeight: isSet(object.haltingHeight) ? globalThis.Number(object.haltingHeight) : 0,
    };
  },

  toJSON(message: MsgResumeFinalityProposal): unknown {
    const obj: any = {};
    if (message.authority !== "") {
      obj.authority = message.authority;
    }
    if (message.fpPksHex?.length) {
      obj.fpPksHex = message.fpPksHex;
    }
    if (message.haltingHeight !== 0) {
      obj.haltingHeight = Math.round(message.haltingHeight);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgResumeFinalityProposal>, I>>(base?: I): MsgResumeFinalityProposal {
    return MsgResumeFinalityProposal.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgResumeFinalityProposal>, I>>(object: I): MsgResumeFinalityProposal {
    const message = createBaseMsgResumeFinalityProposal();
    message.authority = object.authority ?? "";
    message.fpPksHex = object.fpPksHex?.map((e) => e) || [];
    message.haltingHeight = object.haltingHeight ?? 0;
    return message;
  },
};

function createBaseMsgResumeFinalityProposalResponse(): MsgResumeFinalityProposalResponse {
  return {};
}

export const MsgResumeFinalityProposalResponse: MessageFns<MsgResumeFinalityProposalResponse> = {
  encode(_: MsgResumeFinalityProposalResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgResumeFinalityProposalResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgResumeFinalityProposalResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): MsgResumeFinalityProposalResponse {
    return {};
  },

  toJSON(_: MsgResumeFinalityProposalResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgResumeFinalityProposalResponse>, I>>(
    base?: I,
  ): MsgResumeFinalityProposalResponse {
    return MsgResumeFinalityProposalResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgResumeFinalityProposalResponse>, I>>(
    _: I,
  ): MsgResumeFinalityProposalResponse {
    const message = createBaseMsgResumeFinalityProposalResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  CommitPubRandList(request: MsgCommitPubRandList): Promise<MsgCommitPubRandListResponse> {
    ...
    return promise.then((data) => MsgCommitPubRandListResponse.decode(new BinaryReader(data)));
  }

  AddFinalitySig(request: MsgAddFinalitySig): Promise<MsgAddFinalitySigResponse> {
    const data = MsgAddFinalitySig.encode(request).finish();
    const promise = this.rpc.request(this.service, "AddFinalitySig", data);
    return promise.then((data) => MsgAddFinalitySigResponse.decode(new BinaryReader(data)));
  }
  ...
  UnjailFinalityProvider(request: MsgUnjailFinalityProvider): Promise<MsgUnjailFinalityProviderResponse> {
    ...
    const promise = this.rpc.request(this.service, "UnjailFinalityProvider", data);
    return promise.then((data) => MsgUnjailFinalityProviderResponse.decode(new BinaryReader(data)));
  }
