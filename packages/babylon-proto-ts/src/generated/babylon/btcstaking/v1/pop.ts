...
export const ProofOfPossessionBTC: MessageFns<ProofOfPossessionBTC> = {
  encode(message: ProofOfPossessionBTC, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<ProofOfPossessionBTC>, I>>(base?: I): ProofOfPossessionBTC {
...
export const BIP322Sig: MessageFns<BIP322Sig> = {
  encode(message: BIP322Sig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<BIP322Sig>, I>>(object: I): BIP322Sig {
    const message = createBaseBIP322Sig();
