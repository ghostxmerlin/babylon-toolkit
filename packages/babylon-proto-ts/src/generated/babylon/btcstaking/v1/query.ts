...
import { BTCHeaderInfoResponse } from "../../btclightclient/v1/query";
import {
  BTCDelegationStatus,
...
import { Params, StoredParams } from "./params";
...
export interface QueryLargestBtcReOrgRequest {
}

/** QueryLargestBtcReOrgResponse stores the largest BTC reorg recorded */
export interface QueryLargestBtcReOrgResponse {
  /**
  ...
  rollbackTo: BTCHeaderInfoResponse | undefined;
}
 ...
 */
export interface QueryParamsVersionsRequest {
  /** pagination defines an optional pagination for the request. */
  pagination: PageRequest | undefined;
}

/** QueryParamsVersionsResponse stores all the params with versions. */
export interface QueryParamsVersionsResponse {
...
export const QueryParamsByVersionRequest: MessageFns<QueryParamsByVersionRequest> = {
  encode(message: QueryParamsByVersionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<QueryParamsByVersionRequest>, I>>(base?: I): QueryParamsByVersionRequest {
    return QueryParamsByVersionRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsByVersionRequest>, I>>(object: I): QueryParamsByVersionRequest {
    const message = createBaseQueryParamsByVersionRequest();
...
export const QueryParamsByVersionResponse: MessageFns<QueryParamsByVersionResponse> = {
  encode(message: QueryParamsByVersionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      Params.encode(message.params, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<QueryParamsByVersionResponse>, I>>(base?: I): QueryParamsByVersionResponse {
    return QueryParamsByVersionResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsByVersionResponse>, I>>(object: I): QueryParamsByVersionResponse {
    const message = createBaseQueryParamsByVersionResponse();
    message.params = (object.params !== undefined && object.params !== null)
      ? Params.fromPartial(object.params)
      : undefined;
...
function createBaseQueryParamsByBTCHeightRequest(): QueryParamsByBTCHeightRequest {
  return { btcHeight: 0 };
}

export const QueryParamsByBTCHeightRequest: MessageFns<QueryParamsByBTCHeightRequest> = {
  encode(message: QueryParamsByBTCHeightRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.btcHeight !== 0) {
      writer.uint32(8).uint32(message.btcHeight);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryParamsByBTCHeightRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryParamsByBTCHeightRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.btcHeight = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryParamsByBTCHeightRequest {
    return { btcHeight: isSet(object.btcHeight) ? globalThis.Number(object.btcHeight) : 0 };
  },

  toJSON(message: QueryParamsByBTCHeightRequest): unknown {
    const obj: any = {};
    if (message.btcHeight !== 0) {
      obj.btcHeight = Math.round(message.btcHeight);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryParamsByBTCHeightRequest>, I>>(base?: I): QueryParamsByBTCHeightRequest {
    return QueryParamsByBTCHeightRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsByBTCHeightRequest>, I>>(
    object: I,
  ): QueryParamsByBTCHeightRequest {
    const message = createBaseQueryParamsByBTCHeightRequest();
    message.btcHeight = object.btcHeight ?? 0;
    return message;
  },
};

function createBaseQueryParamsByBTCHeightResponse(): QueryParamsByBTCHeightResponse {
  return { params: undefined, version: 0 };
}

export const QueryParamsByBTCHeightResponse: MessageFns<QueryParamsByBTCHeightResponse> = {
  encode(message: QueryParamsByBTCHeightResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.params !== undefined) {
      Params.encode(message.params, writer.uint32(10).fork()).join();
    }
    if (message.version !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryParamsByBTCHeightResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryParamsByBTCHeightResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryParamsByBTCHeightResponse {
    return {
  ...
  toJSON(message: QueryParamsByBTCHeightResponse): unknown {
    const obj: any = {};
    if (message.params !== undefined) {
      obj.params = Params.toJSON(message.params);
    }
  ...
  create<I extends Exact<DeepPartial<QueryParamsByBTCHeightResponse>, I>>(base?: I): QueryParamsByBTCHeightResponse {
    return QueryParamsByBTCHeightResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsByBTCHeightResponse>, I>>(
    object: I,
  ): QueryParamsByBTCHeightResponse {
    const message = createBaseQueryParamsByBTCHeightResponse();
    message.params = (object.params !== undefined && object.params !== null)
      ? Params.fromPartial(object.params)
      : undefined;
...
export const QueryBTCDelegationsRequest: MessageFns<QueryBTCDelegationsRequest> = {
  encode(message: QueryBTCDelegationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.status !== 0) {
  ...
  fromJSON(object: any): QueryBTCDelegationsRequest {
    return {
      status: isSet(object.status) ? bTCDelegationStatusFromJSON(object.status) : 0,
  ...
  create<I extends Exact<DeepPartial<QueryBTCDelegationsRequest>, I>>(base?: I): QueryBTCDelegationsRequest {
    return QueryBTCDelegationsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBTCDelegationsRequest>, I>>(object: I): QueryBTCDelegationsRequest {
    const message = createBaseQueryBTCDelegationsRequest();
...
export const QueryBTCDelegationsResponse: MessageFns<QueryBTCDelegationsResponse> = {
  encode(message: QueryBTCDelegationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryBTCDelegationsResponse {
    return {
      btcDelegations: globalThis.Array.isArray(object?.btcDelegations)
        ? object.btcDelegations.map((e: any) => BTCDelegationResponse.fromJSON(e))
        : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  toJSON(message: QueryBTCDelegationsResponse): unknown {
    ...
    if (message.btcDelegations?.length) {
      obj.btcDelegations = message.btcDelegations.map((e) => BTCDelegationResponse.toJSON(e));
    }
    if (message.pagination !== undefined) {
      obj.pagination = PageResponse.toJSON(message.pagination);
    }
  ...
  create<I extends Exact<DeepPartial<QueryBTCDelegationsResponse>, I>>(base?: I): QueryBTCDelegationsResponse {
    return QueryBTCDelegationsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBTCDelegationsResponse>, I>>(object: I): QueryBTCDelegationsResponse {
    const message = createBaseQueryBTCDelegationsResponse();
...
export const QueryFinalityProviderDelegationsRequest: MessageFns<QueryFinalityProviderDelegationsRequest> = {
  encode(message: QueryFinalityProviderDelegationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fpBtcPkHex !== "") {
      writer.uint32(10).string(message.fpBtcPkHex);
    }
    if (message.pagination !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QueryFinalityProviderDelegationsRequest>, I>>(
    base?: I,
  ): QueryFinalityProviderDelegationsRequest {
    return QueryFinalityProviderDelegationsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryFinalityProviderDelegationsRequest>, I>>(
    object: I,
  ): QueryFinalityProviderDelegationsRequest {
    const message = createBaseQueryFinalityProviderDelegationsRequest();
    message.fpBtcPkHex = object.fpBtcPkHex ?? "";
...
export const QueryFinalityProviderDelegationsResponse: MessageFns<QueryFinalityProviderDelegationsResponse> = {
  encode(message: QueryFinalityProviderDelegationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.btcDelegatorDelegations) {
      BTCDelegatorDelegationsResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
    }
  ...
  fromJSON(object: any): QueryFinalityProviderDelegationsResponse {
    return {
      btcDelegatorDelegations: globalThis.Array.isArray(object?.btcDelegatorDelegations)
        ? object.btcDelegatorDelegations.map((e: any) => BTCDelegatorDelegationsResponse.fromJSON(e))
        : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QueryFinalityProviderDelegationsResponse>, I>>(
    base?: I,
  ): QueryFinalityProviderDelegationsResponse {
    return QueryFinalityProviderDelegationsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryFinalityProviderDelegationsResponse>, I>>(
    object: I,
  ): QueryFinalityProviderDelegationsResponse {
    const message = createBaseQueryFinalityProviderDelegationsResponse();
...
export const QueryBTCDelegationRequest: MessageFns<QueryBTCDelegationRequest> = {
  encode(message: QueryBTCDelegationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): QueryBTCDelegationRequest {
    return { stakingTxHashHex: isSet(object.stakingTxHashHex) ? globalThis.String(object.stakingTxHashHex) : "" };
  },
  ...
  create<I extends Exact<DeepPartial<QueryBTCDelegationRequest>, I>>(base?: I): QueryBTCDelegationRequest {
    return QueryBTCDelegationRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBTCDelegationRequest>, I>>(object: I): QueryBTCDelegationRequest {
    const message = createBaseQueryBTCDelegationRequest();
...
export const QueryBTCDelegationResponse: MessageFns<QueryBTCDelegationResponse> = {
  encode(message: QueryBTCDelegationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.btcDelegation !== undefined) {
      BTCDelegationResponse.encode(message.btcDelegation, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryBTCDelegationResponse {
    return {
      btcDelegation: isSet(object.btcDelegation) ? BTCDelegationResponse.fromJSON(object.btcDelegation) : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<QueryBTCDelegationResponse>, I>>(base?: I): QueryBTCDelegationResponse {
    return QueryBTCDelegationResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBTCDelegationResponse>, I>>(object: I): QueryBTCDelegationResponse {
    const message = createBaseQueryBTCDelegationResponse();
    message.btcDelegation = (object.btcDelegation !== undefined && object.btcDelegation !== null)
...
export const BTCDelegationResponse: MessageFns<BTCDelegationResponse> = {
  encode(message: BTCDelegationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): BTCDelegationResponse {
    return {
      ...
      stakingTxHex: isSet(object.stakingTxHex) ? globalThis.String(object.stakingTxHex) : "",
      slashingTxHex: isSet(object.slashingTxHex) ? globalThis.String(object.slashingTxHex) : "",
      delegatorSlashSigHex: isSet(object.delegatorSlashSigHex) ? globalThis.String(object.delegatorSlashSigHex) : "",
  ...
  toJSON(message: BTCDelegationResponse): unknown {
    ...
    if (message.undelegationResponse !== undefined) {
      obj.undelegationResponse = BTCUndelegationResponse.toJSON(message.undelegationResponse);
    }
    if (message.paramsVersion !== 0) {
  ...
  create<I extends Exact<DeepPartial<BTCDelegationResponse>, I>>(base?: I): BTCDelegationResponse {
    return BTCDelegationResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCDelegationResponse>, I>>(object: I): BTCDelegationResponse {
    const message = createBaseBTCDelegationResponse();
    ...
    message.undelegationResponse = (object.undelegationResponse !== undefined && object.undelegationResponse !== null)
...
export const BTCUndelegationResponse: MessageFns<BTCUndelegationResponse> = {
  encode(message: BTCUndelegationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCUndelegationResponse>, I>>(base?: I): BTCUndelegationResponse {
...
export const BTCDelegatorDelegationsResponse: MessageFns<BTCDelegatorDelegationsResponse> = {
  encode(message: BTCDelegatorDelegationsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCDelegatorDelegationsResponse>, I>>(base?: I): BTCDelegatorDelegationsResponse {
    return BTCDelegatorDelegationsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCDelegatorDelegationsResponse>, I>>(
    object: I,
...
export const FinalityProviderResponse: MessageFns<FinalityProviderResponse> = {
  encode(message: FinalityProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.highestVotedHeight !== 0) {
      writer.uint32(80).uint32(message.highestVotedHeight);
    }
...
function createBaseQueryLargestBtcReOrgRequest(): QueryLargestBtcReOrgRequest {
  return {};
}

export const QueryLargestBtcReOrgRequest: MessageFns<QueryLargestBtcReOrgRequest> = {
  encode(_: QueryLargestBtcReOrgRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryLargestBtcReOrgRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryLargestBtcReOrgRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): QueryLargestBtcReOrgRequest {
    return {};
  },

  toJSON(_: QueryLargestBtcReOrgRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryLargestBtcReOrgRequest>, I>>(base?: I): QueryLargestBtcReOrgRequest {
    return QueryLargestBtcReOrgRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryLargestBtcReOrgRequest>, I>>(_: I): QueryLargestBtcReOrgRequest {
    const message = createBaseQueryLargestBtcReOrgRequest();
    return message;
  },
};

function createBaseQueryLargestBtcReOrgResponse(): QueryLargestBtcReOrgResponse {
  return { blockDiff: 0, rollbackFrom: undefined, rollbackTo: undefined };
}

export const QueryLargestBtcReOrgResponse: MessageFns<QueryLargestBtcReOrgResponse> = {
  encode(message: QueryLargestBtcReOrgResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.blockDiff !== 0) {
      writer.uint32(8).uint32(message.blockDiff);
    }
    if (message.rollbackFrom !== undefined) {
      BTCHeaderInfoResponse.encode(message.rollbackFrom, writer.uint32(18).fork()).join();
    }
    if (message.rollbackTo !== undefined) {
      BTCHeaderInfoResponse.encode(message.rollbackTo, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryLargestBtcReOrgResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryLargestBtcReOrgResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.rollbackFrom = BTCHeaderInfoResponse.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.rollbackTo = BTCHeaderInfoResponse.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryLargestBtcReOrgResponse {
    return {
      blockDiff: isSet(object.blockDiff) ? globalThis.Number(object.blockDiff) : 0,
      rollbackFrom: isSet(object.rollbackFrom) ? BTCHeaderInfoResponse.fromJSON(object.rollbackFrom) : undefined,
      rollbackTo: isSet(object.rollbackTo) ? BTCHeaderInfoResponse.fromJSON(object.rollbackTo) : undefined,
    };
  },

  toJSON(message: QueryLargestBtcReOrgResponse): unknown {
    const obj: any = {};
    if (message.blockDiff !== 0) {
      obj.blockDiff = Math.round(message.blockDiff);
    }
    if (message.rollbackFrom !== undefined) {
      obj.rollbackFrom = BTCHeaderInfoResponse.toJSON(message.rollbackFrom);
    }
    if (message.rollbackTo !== undefined) {
      obj.rollbackTo = BTCHeaderInfoResponse.toJSON(message.rollbackTo);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryLargestBtcReOrgResponse>, I>>(base?: I): QueryLargestBtcReOrgResponse {
    return QueryLargestBtcReOrgResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryLargestBtcReOrgResponse>, I>>(object: I): QueryLargestBtcReOrgResponse {
    const message = createBaseQueryLargestBtcReOrgResponse();
    message.blockDiff = object.blockDiff ?? 0;
    message.rollbackFrom = (object.rollbackFrom !== undefined && object.rollbackFrom !== null)
      ? BTCHeaderInfoResponse.fromPartial(object.rollbackFrom)
      : undefined;
    message.rollbackTo = (object.rollbackTo !== undefined && object.rollbackTo !== null)
      ? BTCHeaderInfoResponse.fromPartial(object.rollbackTo)
      : undefined;
    return message;
  },
};

function createBaseQueryParamsVersionsRequest(): QueryParamsVersionsRequest {
  return { pagination: undefined };
}

export const QueryParamsVersionsRequest: MessageFns<QueryParamsVersionsRequest> = {
  encode(message: QueryParamsVersionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryParamsVersionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryParamsVersionsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): QueryParamsVersionsRequest {
    return { pagination: isSet(object.pagination) ? PageRequest.fromJSON(object.pagination) : undefined };
  },

  toJSON(message: QueryParamsVersionsRequest): unknown {
    const obj: any = {};
    if (message.pagination !== undefined) {
      obj.pagination = PageRequest.toJSON(message.pagination);
    }
  ...
  create<I extends Exact<DeepPartial<QueryParamsVersionsRequest>, I>>(base?: I): QueryParamsVersionsRequest {
    return QueryParamsVersionsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsVersionsRequest>, I>>(object: I): QueryParamsVersionsRequest {
    const message = createBaseQueryParamsVersionsRequest();
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
      : undefined;
...
function createBaseQueryParamsVersionsResponse(): QueryParamsVersionsResponse {
  return { params: [], pagination: undefined };
}

export const QueryParamsVersionsResponse: MessageFns<QueryParamsVersionsResponse> = {
  encode(message: QueryParamsVersionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.params) {
      StoredParams.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryParamsVersionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryParamsVersionsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.params.push(StoredParams.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): QueryParamsVersionsResponse {
    return {
      params: globalThis.Array.isArray(object?.params) ? object.params.map((e: any) => StoredParams.fromJSON(e)) : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },

  toJSON(message: QueryParamsVersionsResponse): unknown {
    const obj: any = {};
    if (message.params?.length) {
      obj.params = message.params.map((e) => StoredParams.toJSON(e));
    }
    if (message.pagination !== undefined) {
      obj.pagination = PageResponse.toJSON(message.pagination);
    }
  ...
  create<I extends Exact<DeepPartial<QueryParamsVersionsResponse>, I>>(base?: I): QueryParamsVersionsResponse {
    return QueryParamsVersionsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryParamsVersionsResponse>, I>>(object: I): QueryParamsVersionsResponse {
    const message = createBaseQueryParamsVersionsResponse();
    message.params = object.params?.map((e) => StoredParams.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageResponse.fromPartial(object.pagination)
      : undefined;
    return message;
...
export interface Query {
  ...
  ParamsVersions(request: QueryParamsVersionsRequest): Promise<QueryParamsVersionsResponse>;
  /**
  ...
  LargestBtcReOrg(request: QueryLargestBtcReOrgRequest): Promise<QueryLargestBtcReOrgResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.ParamsVersions = this.ParamsVersions.bind(this);
    this.ParamsByVersion = this.ParamsByVersion.bind(this);
    this.ParamsByBTCHeight = this.ParamsByBTCHeight.bind(this);
    ...
    this.LargestBtcReOrg = this.LargestBtcReOrg.bind(this);
  }
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
  ...
  ParamsVersions(request: QueryParamsVersionsRequest): Promise<QueryParamsVersionsResponse> {
    const data = QueryParamsVersionsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ParamsVersions", data);
    return promise.then((data) => QueryParamsVersionsResponse.decode(new BinaryReader(data)));
  }
  ...
  ParamsByBTCHeight(request: QueryParamsByBTCHeightRequest): Promise<QueryParamsByBTCHeightResponse> {
    const data = QueryParamsByBTCHeightRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ParamsByBTCHeight", data);
    return promise.then((data) => QueryParamsByBTCHeightResponse.decode(new BinaryReader(data)));
  }
  ...
  FinalityProviderDelegations(
    ...
    const promise = this.rpc.request(this.service, "FinalityProviderDelegations", data);
  ...
  LargestBtcReOrg(request: QueryLargestBtcReOrgRequest): Promise<QueryLargestBtcReOrgResponse> {
    const data = QueryLargestBtcReOrgRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "LargestBtcReOrg", data);
    return promise.then((data) => QueryLargestBtcReOrgResponse.decode(new BinaryReader(data)));
  }
}
