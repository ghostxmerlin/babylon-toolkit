...
export const FinalityProvider: MessageFns<FinalityProvider> = {
  encode(message: FinalityProvider, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.addr !== "") {
  ...
  create<I extends Exact<DeepPartial<FinalityProvider>, I>>(base?: I): FinalityProvider {
    return FinalityProvider.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FinalityProvider>, I>>(object: I): FinalityProvider {
    const message = createBaseFinalityProvider();
...
export const CommissionInfo: MessageFns<CommissionInfo> = {
  encode(message: CommissionInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.maxRate !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CommissionInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<CommissionInfo>, I>>(base?: I): CommissionInfo {
    return CommissionInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CommissionInfo>, I>>(object: I): CommissionInfo {
    const message = createBaseCommissionInfo();
...
export const FinalityProviderWithMeta: MessageFns<FinalityProviderWithMeta> = {
  encode(message: FinalityProviderWithMeta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.btcPk.length !== 0) {
  ...
  create<I extends Exact<DeepPartial<FinalityProviderWithMeta>, I>>(base?: I): FinalityProviderWithMeta {
    return FinalityProviderWithMeta.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FinalityProviderWithMeta>, I>>(object: I): FinalityProviderWithMeta {
    const message = createBaseFinalityProviderWithMeta();
    message.btcPk = object.btcPk ?? new Uint8Array(0);
...
export const BTCDelegation: MessageFns<BTCDelegation> = {
  encode(message: BTCDelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCDelegation>, I>>(base?: I): BTCDelegation {
    return BTCDelegation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCDelegation>, I>>(object: I): BTCDelegation {
    const message = createBaseBTCDelegation();
...
export const BTCUndelegation: MessageFns<BTCUndelegation> = {
  encode(message: BTCUndelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCUndelegation>, I>>(base?: I): BTCUndelegation {
    return BTCUndelegation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCUndelegation>, I>>(object: I): BTCUndelegation {
    const message = createBaseBTCUndelegation();
...
export const BTCDelegatorDelegations: MessageFns<BTCDelegatorDelegations> = {
  encode(message: BTCDelegatorDelegations, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): BTCDelegatorDelegations {
    return {
      dels: globalThis.Array.isArray(object?.dels) ? object.dels.map((e: any) => BTCDelegation.fromJSON(e)) : [],
    };
  },
  ...
  create<I extends Exact<DeepPartial<BTCDelegatorDelegations>, I>>(base?: I): BTCDelegatorDelegations {
    return BTCDelegatorDelegations.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCDelegatorDelegations>, I>>(object: I): BTCDelegatorDelegations {
    const message = createBaseBTCDelegatorDelegations();
...
export const BTCDelegatorDelegationIndex: MessageFns<BTCDelegatorDelegationIndex> = {
  encode(message: BTCDelegatorDelegationIndex, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<BTCDelegatorDelegationIndex>, I>>(base?: I): BTCDelegatorDelegationIndex {
    return BTCDelegatorDelegationIndex.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<BTCDelegatorDelegationIndex>, I>>(object: I): BTCDelegatorDelegationIndex {
    const message = createBaseBTCDelegatorDelegationIndex();
...
export const SignatureInfo: MessageFns<SignatureInfo> = {
  ...
  create<I extends Exact<DeepPartial<SignatureInfo>, I>>(base?: I): SignatureInfo {
    return SignatureInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SignatureInfo>, I>>(object: I): SignatureInfo {
    const message = createBaseSignatureInfo();
...
export const CovenantAdaptorSignatures: MessageFns<CovenantAdaptorSignatures> = {
  encode(message: CovenantAdaptorSignatures, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<CovenantAdaptorSignatures>, I>>(base?: I): CovenantAdaptorSignatures {
    return CovenantAdaptorSignatures.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CovenantAdaptorSignatures>, I>>(object: I): CovenantAdaptorSignatures {
    const message = createBaseCovenantAdaptorSignatures();
...
export const SelectiveSlashingEvidence: MessageFns<SelectiveSlashingEvidence> = {
  encode(message: SelectiveSlashingEvidence, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<SelectiveSlashingEvidence>, I>>(base?: I): SelectiveSlashingEvidence {
    return SelectiveSlashingEvidence.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SelectiveSlashingEvidence>, I>>(object: I): SelectiveSlashingEvidence {
    const message = createBaseSelectiveSlashingEvidence();
...
export const LargestBtcReOrg: MessageFns<LargestBtcReOrg> = {
  encode(message: LargestBtcReOrg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.blockDiff !== 0) {
      writer.uint32(8).uint32(message.blockDiff);
    }
    if (message.rollbackFrom !== undefined) {
      BTCHeaderInfo.encode(message.rollbackFrom, writer.uint32(18).fork()).join();
    }
    if (message.rollbackTo !== undefined) {
      BTCHeaderInfo.encode(message.rollbackTo, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): LargestBtcReOrg {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): LargestBtcReOrg {
    return {
      ...
      rollbackFrom: isSet(object.rollbackFrom) ? BTCHeaderInfo.fromJSON(object.rollbackFrom) : undefined,
      rollbackTo: isSet(object.rollbackTo) ? BTCHeaderInfo.fromJSON(object.rollbackTo) : undefined,
    };
  },
  ...
  toJSON(message: LargestBtcReOrg): unknown {
    ...
    if (message.rollbackFrom !== undefined) {
      obj.rollbackFrom = BTCHeaderInfo.toJSON(message.rollbackFrom);
    }
    if (message.rollbackTo !== undefined) {
      obj.rollbackTo = BTCHeaderInfo.toJSON(message.rollbackTo);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<LargestBtcReOrg>, I>>(base?: I): LargestBtcReOrg {
    return LargestBtcReOrg.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LargestBtcReOrg>, I>>(object: I): LargestBtcReOrg {
    const message = createBaseLargestBtcReOrg();
