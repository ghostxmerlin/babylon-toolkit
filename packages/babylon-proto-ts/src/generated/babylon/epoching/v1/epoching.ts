...
export const QueuedMessage: MessageFns<QueuedMessage> = {
  encode(message: QueuedMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.msgCreateValidator !== undefined) {
      MsgCreateValidator.encode(message.msgCreateValidator, writer.uint32(42).fork()).join();
    }
    ...
    if (message.msgUndelegate !== undefined) {
      MsgUndelegate.encode(message.msgUndelegate, writer.uint32(58).fork()).join();
    }
    if (message.msgBeginRedelegate !== undefined) {
      MsgBeginRedelegate.encode(message.msgBeginRedelegate, writer.uint32(66).fork()).join();
    }
    if (message.msgCancelUnbondingDelegation !== undefined) {
      MsgCancelUnbondingDelegation.encode(message.msgCancelUnbondingDelegation, writer.uint32(74).fork()).join();
    }
    if (message.msgEditValidator !== undefined) {
      MsgEditValidator.encode(message.msgEditValidator, writer.uint32(82).fork()).join();
    }
    if (message.msgUpdateParams !== undefined) {
      MsgUpdateParams.encode(message.msgUpdateParams, writer.uint32(90).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueuedMessage {
    return {
      ...
      msgCancelUnbondingDelegation: isSet(object.msgCancelUnbondingDelegation)
        ? MsgCancelUnbondingDelegation.fromJSON(object.msgCancelUnbondingDelegation)
        : undefined,
  ...
  toJSON(message: QueuedMessage): unknown {
    ...
    if (message.msgBeginRedelegate !== undefined) {
      obj.msgBeginRedelegate = MsgBeginRedelegate.toJSON(message.msgBeginRedelegate);
    }
    if (message.msgCancelUnbondingDelegation !== undefined) {
      obj.msgCancelUnbondingDelegation = MsgCancelUnbondingDelegation.toJSON(message.msgCancelUnbondingDelegation);
    }
    if (message.msgEditValidator !== undefined) {
      obj.msgEditValidator = MsgEditValidator.toJSON(message.msgEditValidator);
    }
    if (message.msgUpdateParams !== undefined) {
      obj.msgUpdateParams = MsgUpdateParams.toJSON(message.msgUpdateParams);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<QueuedMessage>, I>>(base?: I): QueuedMessage {
  ...
  fromPartial<I extends Exact<DeepPartial<QueuedMessage>, I>>(object: I): QueuedMessage {
    ...
    message.msgCancelUnbondingDelegation =
      (object.msgCancelUnbondingDelegation !== undefined && object.msgCancelUnbondingDelegation !== null)
        ? MsgCancelUnbondingDelegation.fromPartial(object.msgCancelUnbondingDelegation)
        : undefined;
    message.msgEditValidator = (object.msgEditValidator !== undefined && object.msgEditValidator !== null)
      ? MsgEditValidator.fromPartial(object.msgEditValidator)
      : undefined;
    message.msgUpdateParams = (object.msgUpdateParams !== undefined && object.msgUpdateParams !== null)
      ? MsgUpdateParams.fromPartial(object.msgUpdateParams)
      : undefined;
    return message;
  },
};
...
export const ValStateUpdate: MessageFns<ValStateUpdate> = {
  encode(message: ValStateUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  create<I extends Exact<DeepPartial<ValStateUpdate>, I>>(base?: I): ValStateUpdate {
...
export const ValidatorLifecycle: MessageFns<ValidatorLifecycle> = {
  encode(message: ValidatorLifecycle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.valAddr !== "") {
  ...
  create<I extends Exact<DeepPartial<ValidatorLifecycle>, I>>(base?: I): ValidatorLifecycle {
...
export const DelegationStateUpdate: MessageFns<DelegationStateUpdate> = {
  encode(message: DelegationStateUpdate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
      writer.uint32(8).int32(message.state);
    }
    if (message.valAddr !== "") {
  ...
  create<I extends Exact<DeepPartial<DelegationStateUpdate>, I>>(base?: I): DelegationStateUpdate {
...
export const DelegationLifecycle: MessageFns<DelegationLifecycle> = {
  encode(message: DelegationLifecycle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delAddr !== "") {
  ...
  create<I extends Exact<DeepPartial<DelegationLifecycle>, I>>(base?: I): DelegationLifecycle {
