...
export const EventBeginEpoch: MessageFns<EventBeginEpoch> = {
  encode(message: EventBeginEpoch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<EventBeginEpoch>, I>>(base?: I): EventBeginEpoch {
...
export const EventEndEpoch: MessageFns<EventEndEpoch> = {
  encode(message: EventEndEpoch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.epochNumber !== 0) {
      writer.uint32(8).uint64(message.epochNumber);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<EventEndEpoch>, I>>(base?: I): EventEndEpoch {
...
export const EventHandleQueuedMsg: MessageFns<EventHandleQueuedMsg> = {
  encode(message: EventHandleQueuedMsg, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): EventHandleQueuedMsg {
    return {
      originalEventType: isSet(object.originalEventType) ? globalThis.String(object.originalEventType) : "",
  ...
  toJSON(message: EventHandleQueuedMsg): unknown {
    ...
    if (message.originalAttributes?.length) {
      obj.originalAttributes = message.originalAttributes.map((e) => base64FromBytes(e));
    }
    if (message.error !== "") {
  ...
  create<I extends Exact<DeepPartial<EventHandleQueuedMsg>, I>>(base?: I): EventHandleQueuedMsg {
...
export const EventSlashThreshold: MessageFns<EventSlashThreshold> = {
  encode(message: EventSlashThreshold, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): EventSlashThreshold {
    return {
      slashedVotingPower: isSet(object.slashedVotingPower) ? globalThis.Number(object.slashedVotingPower) : 0,
  ...
  toJSON(message: EventSlashThreshold): unknown {
    ...
    if (message.slashedValidators?.length) {
      obj.slashedValidators = message.slashedValidators.map((e) => base64FromBytes(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<EventSlashThreshold>, I>>(base?: I): EventSlashThreshold {
...
function createBaseEventWrappedDelegate(): EventWrappedDelegate {
  return { delegatorAddress: "", validatorAddress: "", amount: 0, denom: "", epochBoundary: 0 };
}

export const EventWrappedDelegate: MessageFns<EventWrappedDelegate> = {
  encode(message: EventWrappedDelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  create<I extends Exact<DeepPartial<EventWrappedDelegate>, I>>(base?: I): EventWrappedDelegate {
...
export const EventWrappedUndelegate: MessageFns<EventWrappedUndelegate> = {
  encode(message: EventWrappedUndelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    if (message.validatorAddress !== "") {
  ...
  create<I extends Exact<DeepPartial<EventWrappedUndelegate>, I>>(base?: I): EventWrappedUndelegate {
...
export const EventWrappedBeginRedelegate: MessageFns<EventWrappedBeginRedelegate> = {
  encode(message: EventWrappedBeginRedelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
  ...
  create<I extends Exact<DeepPartial<EventWrappedBeginRedelegate>, I>>(base?: I): EventWrappedBeginRedelegate {
...
function createBaseEventWrappedCancelUnbondingDelegation(): EventWrappedCancelUnbondingDelegation {
  return { delegatorAddress: "", validatorAddress: "", amount: 0, creationHeight: 0, epochBoundary: 0 };
}

export const EventWrappedCancelUnbondingDelegation: MessageFns<EventWrappedCancelUnbondingDelegation> = {
  encode(message: EventWrappedCancelUnbondingDelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.delegatorAddress !== "") {
      writer.uint32(10).string(message.delegatorAddress);
    }
    if (message.validatorAddress !== "") {
  ...
  create<I extends Exact<DeepPartial<EventWrappedCancelUnbondingDelegation>, I>>(
    base?: I,
  ): EventWrappedCancelUnbondingDelegation {
    return EventWrappedCancelUnbondingDelegation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventWrappedCancelUnbondingDelegation>, I>>(
    object: I,
  ): EventWrappedCancelUnbondingDelegation {
    const message = createBaseEventWrappedCancelUnbondingDelegation();
    message.delegatorAddress = object.delegatorAddress ?? "";
...
function createBaseEventWrappedEditValidator(): EventWrappedEditValidator {
  return { validatorAddress: "", epochBoundary: 0 };
}

export const EventWrappedEditValidator: MessageFns<EventWrappedEditValidator> = {
  encode(message: EventWrappedEditValidator, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.validatorAddress !== "") {
  ...
  toJSON(message: EventWrappedEditValidator): unknown {
    const obj: any = {};
    if (message.validatorAddress !== "") {
      obj.validatorAddress = message.validatorAddress;
    }
  ...
  create<I extends Exact<DeepPartial<EventWrappedEditValidator>, I>>(base?: I): EventWrappedEditValidator {
    return EventWrappedEditValidator.fromPartial(base ?? ({} as any));
  },
...
export const EventWrappedStakingUpdateParams: MessageFns<EventWrappedStakingUpdateParams> = {
  encode(message: EventWrappedStakingUpdateParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  toJSON(message: EventWrappedStakingUpdateParams): unknown {
    const obj: any = {};
    if (message.unbondingTime !== "") {
  ...
  create<I extends Exact<DeepPartial<EventWrappedStakingUpdateParams>, I>>(base?: I): EventWrappedStakingUpdateParams {
    return EventWrappedStakingUpdateParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventWrappedStakingUpdateParams>, I>>(
    object: I,
  ): EventWrappedStakingUpdateParams {
    const message = createBaseEventWrappedStakingUpdateParams();
