...
import {
  ...
  MsgEditValidator,
  MsgUndelegate,
  MsgUpdateParams as MsgUpdateParams1,
...
export const MsgWrappedDelegate: MessageFns<MsgWrappedDelegate> = {
  encode(message: MsgWrappedDelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): MsgWrappedDelegate {
    return { msg: isSet(object.msg) ? MsgDelegate.fromJSON(object.msg) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedDelegate>, I>>(base?: I): MsgWrappedDelegate {
...
export const MsgWrappedDelegateResponse: MessageFns<MsgWrappedDelegateResponse> = {
  encode(_: MsgWrappedDelegateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedDelegateResponse>, I>>(base?: I): MsgWrappedDelegateResponse {
...
export const MsgWrappedUndelegate: MessageFns<MsgWrappedUndelegate> = {
  encode(message: MsgWrappedUndelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== undefined) {
  ...
  fromJSON(object: any): MsgWrappedUndelegate {
    return { msg: isSet(object.msg) ? MsgUndelegate.fromJSON(object.msg) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedUndelegate>, I>>(base?: I): MsgWrappedUndelegate {
...
export const MsgWrappedUndelegateResponse: MessageFns<MsgWrappedUndelegateResponse> = {
  encode(_: MsgWrappedUndelegateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedUndelegateResponse>, I>>(base?: I): MsgWrappedUndelegateResponse {
...
export const MsgWrappedBeginRedelegate: MessageFns<MsgWrappedBeginRedelegate> = {
  encode(message: MsgWrappedBeginRedelegate, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== undefined) {
  ...
  fromJSON(object: any): MsgWrappedBeginRedelegate {
    return { msg: isSet(object.msg) ? MsgBeginRedelegate.fromJSON(object.msg) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedBeginRedelegate>, I>>(base?: I): MsgWrappedBeginRedelegate {
...
export const MsgWrappedBeginRedelegateResponse: MessageFns<MsgWrappedBeginRedelegateResponse> = {
  encode(_: MsgWrappedBeginRedelegateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgWrappedBeginRedelegateResponse>, I>>(
    _: I,
  ): MsgWrappedBeginRedelegateResponse {
    const message = createBaseMsgWrappedBeginRedelegateResponse();
    return message;
...
export const MsgWrappedCancelUnbondingDelegation: MessageFns<MsgWrappedCancelUnbondingDelegation> = {
  encode(message: MsgWrappedCancelUnbondingDelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== undefined) {
      MsgCancelUnbondingDelegation.encode(message.msg, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): MsgWrappedCancelUnbondingDelegation {
    return { msg: isSet(object.msg) ? MsgCancelUnbondingDelegation.fromJSON(object.msg) : undefined };
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedCancelUnbondingDelegation>, I>>(
    base?: I,
  ): MsgWrappedCancelUnbondingDelegation {
    return MsgWrappedCancelUnbondingDelegation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgWrappedCancelUnbondingDelegation>, I>>(
    object: I,
  ): MsgWrappedCancelUnbondingDelegation {
    const message = createBaseMsgWrappedCancelUnbondingDelegation();
    message.msg = (object.msg !== undefined && object.msg !== null)
...
export const MsgWrappedCancelUnbondingDelegationResponse: MessageFns<MsgWrappedCancelUnbondingDelegationResponse> = {
  encode(_: MsgWrappedCancelUnbondingDelegationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedCancelUnbondingDelegationResponse>, I>>(
    base?: I,
  ): MsgWrappedCancelUnbondingDelegationResponse {
    return MsgWrappedCancelUnbondingDelegationResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgWrappedCancelUnbondingDelegationResponse>, I>>(
    _: I,
  ): MsgWrappedCancelUnbondingDelegationResponse {
    const message = createBaseMsgWrappedCancelUnbondingDelegationResponse();
    return message;
...
export const MsgWrappedEditValidator: MessageFns<MsgWrappedEditValidator> = {
  encode(message: MsgWrappedEditValidator, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== undefined) {
      MsgEditValidator.encode(message.msg, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): MsgWrappedEditValidator {
    return { msg: isSet(object.msg) ? MsgEditValidator.fromJSON(object.msg) : undefined };
  },

  toJSON(message: MsgWrappedEditValidator): unknown {
    const obj: any = {};
    if (message.msg !== undefined) {
      obj.msg = MsgEditValidator.toJSON(message.msg);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgWrappedEditValidator>, I>>(base?: I): MsgWrappedEditValidator {
    return MsgWrappedEditValidator.fromPartial(base ?? ({} as any));
  },
...
export const MsgWrappedEditValidatorResponse: MessageFns<MsgWrappedEditValidatorResponse> = {
  encode(_: MsgWrappedEditValidatorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  create<I extends Exact<DeepPartial<MsgWrappedEditValidatorResponse>, I>>(base?: I): MsgWrappedEditValidatorResponse {
    return MsgWrappedEditValidatorResponse.fromPartial(base ?? ({} as any));
  },
...
export const MsgWrappedStakingUpdateParams: MessageFns<MsgWrappedStakingUpdateParams> = {
  encode(message: MsgWrappedStakingUpdateParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.msg !== undefined) {
      MsgUpdateParams1.encode(message.msg, writer.uint32(10).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): MsgWrappedStakingUpdateParams {
    return { msg: isSet(object.msg) ? MsgUpdateParams1.fromJSON(object.msg) : undefined };
  },

  toJSON(message: MsgWrappedStakingUpdateParams): unknown {
    const obj: any = {};
    if (message.msg !== undefined) {
      obj.msg = MsgUpdateParams1.toJSON(message.msg);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgWrappedStakingUpdateParams>, I>>(base?: I): MsgWrappedStakingUpdateParams {
    return MsgWrappedStakingUpdateParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgWrappedStakingUpdateParams>, I>>(
    object: I,
  ): MsgWrappedStakingUpdateParams {
    const message = createBaseMsgWrappedStakingUpdateParams();
    message.msg = (object.msg !== undefined && object.msg !== null)
      ? MsgUpdateParams1.fromPartial(object.msg)
      : undefined;
    return message;
  },
};
...
export const MsgWrappedStakingUpdateParamsResponse: MessageFns<MsgWrappedStakingUpdateParamsResponse> = {
  encode(_: MsgWrappedStakingUpdateParamsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  toJSON(_: MsgWrappedStakingUpdateParamsResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgWrappedStakingUpdateParamsResponse>, I>>(
    base?: I,
  ): MsgWrappedStakingUpdateParamsResponse {
    return MsgWrappedStakingUpdateParamsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgWrappedStakingUpdateParamsResponse>, I>>(
    _: I,
  ): MsgWrappedStakingUpdateParamsResponse {
    const message = createBaseMsgWrappedStakingUpdateParamsResponse();
    return message;
