...
import { VaultController, Morpho } from '../../clients/eth-contract';
import type { VaultMetadata, MorphoUserPosition } from '../../clients/eth-contract';
 ...
 * @returns Complete vault position with Morpho data
 */
export async function getVaultPositionWithMorpho(
  ...
  // Step 2: Fetch Morpho position using proxy contract address
 ...
 *
 * Composite operation that combines getUserVaultsWithDetails + Morpho positions
 *
 * @param userAddress - User's Ethereum address
 * @param vaultControllerAddress - BTCVaultController contract address
 * @param marketId - Morpho market ID
 * @returns Array of vault positions with Morpho data
 */
