 ...
 */
export const MORPHO_MARKET_ID = process.env.NEXT_PUBLIC_VAULT_MORPHO_MARKET_ID || '74452254177513794647796445278347016294878377877693199253750000625994101441252' as const;
